...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'exit_plan_mode', 'faberloom_agents_create', 'faberloom_agents_deactivate', 'faberloom_agents_delegate', 'faberloom_agents_duplicate', 'faberloom_agents_evidence',
      'faberloom_agents_execute_tool', 'faberloom_agents_list', 'faberloom_agents_recommend_model', 'faberloom_agents_record_outcome', 'faberloom_agents_resolve_model', 'faberloom_agents_run_subagent',
      'faberloom_agents_update', 'faberloom_board_create', 'faberloom_board_exception', 'faberloom_board_get', 'faberloom_board_list', 'faberloom_board_mark_stale',
      'faberloom_board_record_effect', 'faberloom_board_revalidate', 'faberloom_board_review', 'faberloom_board_submit_revision', 'faberloom_events_ingest', 'faberloom_executions_cancel_effect',
      'faberloom_executions_get', 'faberloom_executions_list', 'faberloom_executions_migrate', 'faberloom_executions_reconcile', 'faberloom_executions_start', 'faberloom_executions_tick',
      'faberloom_models_list', 'faberloom_models_register', 'faberloom_models_sync_pool', 'faberloom_routines_activate', 'faberloom_routines_create', 'faberloom_routines_list',
      'faberloom_routines_pause', 'faberloom_routines_update', 'faberloom_routines_version', 'faberloom_sources_list', 'faberloom_sources_register', 'faberloom_spaces_archive',
      'faberloom_spaces_attach_file', 'faberloom_spaces_create', 'faberloom_spaces_effective_context', 'faberloom_spaces_get', 'faberloom_spaces_list', 'faberloom_spaces_list_files',
      'faberloom_spaces_preview_link', 'faberloom_spaces_read_file', 'faberloom_spaces_resolve_workdir', 'faberloom_spaces_update', 'faberloom_spaces_validate_source', 'get_goal',
      'glob', 'grep', 'interrupt_agent', 'interrupt_agent', 'job_kill', 'job_list',
      'job_output', 'list_agents', 'list_agents', 'list_mcp_resource_templates', 'list_mcp_resources', 'list_subagent_models',
      'lsp', 'present', 'pwsh', 'pwsh', 'ralph', 'read',
      'read_image', 'read_mcp_resource', 'run_code', 'schedule_create', 'schedule_delete', 'schedule_list',
      'send_message', 'send_message', 'session_event_read', 'session_event_search', 'session_event_trace', 'session_search',
      'session_trace', 'skill', 'spawn_teammate', 'stagehand_act', 'stagehand_extract', 'stagehand_navigate',
      'stagehand_observe', 'stagehand_screenshot', 'stagehand_tabs', 'str_replace_editor', 'subagent', 'team_task_create',
      'team_task_get', 'team_task_list', 'team_task_update', 'terminal_close', 'terminal_list', 'terminal_open',
      'terminal_read', 'terminal_send', 'terminal_signal', 'todo_write', 'update_goal', 'wait_agent',
