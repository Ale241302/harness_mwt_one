...
import faberloomViewRemote from '@deepseek-ai/dsh-faberloom-view/remote'
...
export type {} from '@deepseek-ai/dsh-faberloom-view/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      agentPresetsRemote, commandsRemote, settingsControllerRemote, goalsRemote, faberloomViewRemote, llmRemote, dynamicRemote,
