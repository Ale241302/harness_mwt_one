...
export const zh = {
  ...
  'delete.session': '删除会话',
  'delete.session.desc': '将永久删除“{name}”及其分叉出的子会话。此操作无法撤销。',
  'delete.orphans': '删除所有未分组',
  'delete.orphans.desc': '将永久删除所有不属于任何工作区的会话。此操作无法撤销。',
...
export const en = {
  ...
  'delete.session.desc': 'This permanently deletes “{name}” and every session forked from it. This cannot be undone.',
  'delete.orphans': 'Delete all Ungrouped',
  'delete.orphans.desc': 'This permanently deletes every session that belongs to no workspace. This cannot be undone.',
