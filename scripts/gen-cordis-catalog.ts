...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  faberloomSpaces: 'faberloom.md',
  faberloomBoard: 'faberloom.md',
  faberloomAgents: 'faberloom.md',
  faberloomRoutines: 'faberloom.md',
  faberloomExecutions: 'faberloom.md',
  faberloomMemory: 'faberloom.md',
  faberloomView: 'faberloom.md',
  faberloomConnections: 'faberloom.md',
  faberloomHandlers: 'faberloom.md',
  faberloomDefaults: 'faberloom.md',
  faberloomInbound: 'faberloom.md',
  faberloomMcpServer: 'faberloom.md',
  faberloomAccess: 'faberloom.md',
  faberloomBackup: 'faberloom.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  FaberLoomSpaceId: 'faberloom.md',
  FaberLoomOverview: 'faberloom.md',
  FaberLoomSpaceRow: 'faberloom.md',
  FaberLoomAgentRow: 'faberloom.md',
  FaberLoomBoardRow: 'faberloom.md',
  FaberLoomRoutineRow: 'faberloom.md',
  FaberLoomConnection: 'faberloom.md',
  ConnectionInput: 'faberloom.md',
  ConnectionProbe: 'faberloom.md',
  FaberLoomRoutineDetail: 'faberloom.md',
  FaberLoomRoutineStepRow: 'faberloom.md',
  FaberLoomExecutionRow: 'faberloom.md',
  SeedReport: 'faberloom.md',
  DispatchReport: 'faberloom.md',
  InboundReport: 'faberloom.md',
  FaberLoomModelRow: 'faberloom.md',
  FaberLoomModelRecommendation: 'faberloom.md',
  FaberLoomModelCandidate: 'faberloom.md',
  FaberLoomTeachingRow: 'faberloom.md',
  FaberLoomPerformanceRow: 'faberloom.md',
  FaberLoomCostRow: 'faberloom.md',
  FaberLoomCostSummary: 'faberloom.md',
  FaberLoomGrantRow: 'faberloom.md',
  FaberLoomBackupManifest: 'faberloom.md',
  FaberLoomBackupDomainDigest: 'faberloom.md',
  FaberLoomBackupTableDigest: 'faberloom.md',
  FaberLoomBackupVerifyResult: 'faberloom.md',
  FaberLoomBackupTableVerdict: 'faberloom.md',
  FaberLoomBackupRow: 'faberloom.md',
  FaberLoomBackupVerify: 'faberloom.md',
  FaberLoomBackupRestore: 'faberloom.md',
  FaberLoomDataMigration: 'faberloom.md',
  FaberLoomMigrationInfo: 'faberloom.md',
  FaberLoomMigrationReport: 'faberloom.md',
  FaberLoomProposalAgent: 'faberloom.md',
  FaberLoomWorkProposal: 'faberloom.md',
  FaberLoomLinkPreview: 'faberloom.md',
  FaberLoomRestoreResult: 'faberloom.md',
  FaberLoomRestoreTable: 'faberloom.md',
  FaberLoomRestoreSkip: 'faberloom.md',
  CreateBackupOptions: 'faberloom.md',
  RestoreBackupOptions: 'faberloom.md',
  TeachingSaveInput: 'faberloom.md',
  GrantSaveInput: 'faberloom.md',
  FaberLoomMcpToken: 'faberloom.md',
  FaberLoomMcpTokenRow: 'faberloom.md',
  McpTokenInput: 'faberloom.md',
  ImapMessage: 'faberloom.md',
  ImapCredentials: 'faberloom.md',
  CursorRecord: 'faberloom.md',
  RoutineSaveInput: 'faberloom.md',
  FaberLoomSpaceDetail: 'faberloom.md',
  SpaceSaveInput: 'faberloom.md',
  FaberLoomBoardDetail: 'faberloom.md',
  FaberLoomAgentDetail: 'faberloom.md',
  AgentSaveInput: 'faberloom.md',
  FaberLoomSkillRow: 'faberloom.md',
  FaberLoomSpace: 'faberloom.md',
  SpaceActor: 'faberloom.md',
  SpaceContext: 'faberloom.md',
  SpaceSource: 'faberloom.md',
  SpaceFile: 'faberloom.md',
  FaberLoomModelId: 'faberloom.md',
  FaberLoomModel: 'faberloom.md',
  ModelInput: 'faberloom.md',
  FaberLoomAgentId: 'faberloom.md',
  FaberLoomAgent: 'faberloom.md',
  AgentInput: 'faberloom.md',
  AgentPatch: 'faberloom.md',
  DuplicateInput: 'faberloom.md',
  ModelPolicy: 'faberloom.md',
  PolicyPatch: 'faberloom.md',
  EscalationPolicy: 'faberloom.md',
  BudgetPolicy: 'faberloom.md',
  ResolveRequest: 'faberloom.md',
  ResolveResult: 'faberloom.md',
  ResolveStatus: 'faberloom.md',
  RecommendRequest: 'faberloom.md',
  RecommendResult: 'faberloom.md',
  RecommendCandidate: 'faberloom.md',
  Selection: 'faberloom.md',
  SelectionInput: 'faberloom.md',
  Outcome: 'faberloom.md',
  OutcomeInput: 'faberloom.md',
  EvidenceSummary: 'faberloom.md',
  CostBucket: 'faberloom.md',
  CostSummary: 'faberloom.md',
  DelegateRequest: 'faberloom.md',
  DelegateResult: 'faberloom.md',
  RunTemporarySubagentRequest: 'faberloom.md',
  TemporarySubagentResult: 'faberloom.md',
  FaberLoomRoutineId: 'faberloom.md',
  FaberLoomExecutionId: 'faberloom.md',
  RoutineStatus: 'faberloom.md',
  ExecutionStatus: 'faberloom.md',
  RoutineTrigger: 'faberloom.md',
  RoutineTriggerInput: 'faberloom.md',
  RoutineStep: 'faberloom.md',
  RoutineStepInput: 'faberloom.md',
  RoutineDefinition: 'faberloom.md',
  RoutineDefinitionInput: 'faberloom.md',
  FaberLoomRoutine: 'faberloom.md',
  RoutineInput: 'faberloom.md',
  ExecutionEvidence: 'faberloom.md',
  StepState: 'faberloom.md',
  Execution: 'faberloom.md',
  StepContext: 'faberloom.md',
  StepHandler: 'faberloom.md',
  IngestEvent: 'faberloom.md',
  EventSource: 'faberloom.md',
  StartExecutionRequest: 'faberloom.md',
  StartExecutionResult: 'faberloom.md',
  TickRequest: 'faberloom.md',
  TickResult: 'faberloom.md',
  MigrationPlan: 'faberloom.md',
  FaberLoomBoardItemId: 'faberloom.md',
  BoardStatus: 'faberloom.md',
  BoardRevision: 'faberloom.md',
  BoardReview: 'faberloom.md',
  BoardEffect: 'faberloom.md',
  FaberLoomBoardItem: 'faberloom.md',
  BoardSubmitInput: 'faberloom.md',
  BoardCreateInput: 'faberloom.md',
  BoardReviewInput: 'faberloom.md',
  BoardEffectInput: 'faberloom.md',
  FaberLoomTeachingId: 'faberloom.md',
  TeachingScope: 'faberloom.md',
  TeachingStatus: 'faberloom.md',
  FaberLoomTeaching: 'faberloom.md',
  TeachingInput: 'faberloom.md',
  TeachingEditInput: 'faberloom.md',
  TeachingFilter: 'faberloom.md',
  PerformanceCause: 'faberloom.md',
  PerformanceInput: 'faberloom.md',
  PerformanceSummary: 'faberloom.md',
  LateErrorInput: 'faberloom.md',
  KnowledgeSnapshot: 'faberloom.md',
  FaberLoomGrantId: 'faberloom.md',
  FaberLoomGrant: 'faberloom.md',
  GrantInput: 'faberloom.md',
  GrantCheck: 'faberloom.md',
  GrantDecision: 'faberloom.md',
  SpaceFileContent: 'faberloom.md',
  SpaceFileInput: 'faberloom.md',
  CreateSpaceInput: 'faberloom.md',
  UpdateSpaceInput: 'faberloom.md',
  EffectiveContext: 'faberloom.md',
  EffectiveContextConflict: 'faberloom.md',
  PersonalScope: 'faberloom.md',
  WorkdirReference: 'faberloom.md',
  LinkPreview: 'faberloom.md',
  Agent: 'core.md',
