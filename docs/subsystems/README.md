...
| [faberloom.md](faberloom.md) | the native product modules: thematic spaces, agent catalogs with model policy, declarative routines, persistent execution, memory, elective autonomy, and knowledge backup |
