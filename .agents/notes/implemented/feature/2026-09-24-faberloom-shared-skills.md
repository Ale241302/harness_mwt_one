...
- Import scope: 292 ECC skills copied verbatim and 94 ECC commands rewritten as user-invocable skills named `cmd-<command>`. ECC agents are not skills here; they ship as native presets ([note](2026-09-24-faberloom-native-agent-presets.md)).
