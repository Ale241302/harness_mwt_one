---
name: mwt-admin-roles-editar
description: "Rol Admin (CEO) · módulo Roles y Permisos (roles) · permiso editar (actualizar/modificar). Úsala cuando el usuario quiera editar, actualizar, corregir o cambiar algo en roles. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/roles.md antes de actuar."
role: admin
module: roles
action: update
---

# mwt-admin-roles-editar

> Skill MCP enfocado: **Admin (CEO)** · **Roles y Permisos** · permiso **editar** (actualizar/modificar).
