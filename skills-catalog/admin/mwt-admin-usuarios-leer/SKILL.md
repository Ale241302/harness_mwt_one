...
description: "Rol Admin (CEO) · módulo Usuarios (usuarios) · permiso leer (consultar/listar). Úsala cuando el usuario quiera consultar, listar, ver, buscar o revisar usuarios (por ejemplo 'muéstrame usuarios' o 'busca en usuarios'). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/usuarios.md antes de actuar."
role: admin
module: usuarios
action: view
---

# mwt-admin-usuarios-leer

> Skill MCP enfocado: **Admin (CEO)** · **Usuarios** · permiso **leer** (consultar/listar).
