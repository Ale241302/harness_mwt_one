---
name: mwt-admin-tickets-descargar-documento
description: "Rol Admin (CEO) · módulo Tickets (tickets) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de tickets. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/tickets.md antes de actuar."
role: admin
module: tickets
action: download_doc
---

# mwt-admin-tickets-descargar-documento

> Skill MCP enfocado: **Admin (CEO)** · **Tickets** · permiso **descargar-documento** (descargar un archivo/documento).
