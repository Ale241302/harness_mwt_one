---
name: mwt-admin-cartera-eliminar
description: "Rol Admin (CEO) · módulo Cartera (cartera) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de cartera. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/cartera.md antes de actuar."
role: admin
module: cartera
action: delete
---

# mwt-admin-cartera-eliminar

> Skill MCP enfocado: **Admin (CEO)** · **Cartera** · permiso **eliminar** (eliminar/borrar).

## Propósito
Operar el módulo **Cartera** (`cartera`) con la acción **eliminar** (eliminar/borrar) usando SOLO
...
- El alcance de este skill es **eliminar** sobre **Cartera**; para otra operación activá el SKILL.md correspondiente.
