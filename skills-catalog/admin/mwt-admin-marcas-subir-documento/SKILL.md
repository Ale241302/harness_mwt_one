---
name: mwt-admin-marcas-subir-documento
description: "Rol Admin (CEO) · módulo Marcas (marcas) · permiso subir-documento (subir un archivo/documento). Úsala cuando el usuario quiera subir o adjuntar un documento a marcas. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/marcas.md antes de actuar."
role: admin
module: marcas
action: upload_doc
---

# mwt-admin-marcas-subir-documento

> Skill MCP enfocado: **Admin (CEO)** · **Marcas** · permiso **subir-documento** (subir un archivo/documento).

## Propósito
Operar el módulo **Marcas** (`marcas`) con la acción **subir-documento** (subir un archivo/documento) usando SOLO
...
- El alcance de este skill es **subir-documento** sobre **Marcas**; para otra operación activá el SKILL.md correspondiente.
