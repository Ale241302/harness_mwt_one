---
name: mwt-admin-inventario-ver-documento
description: "Rol Admin (CEO) · módulo Inventario (inventario) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de inventario. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/inventario.md antes de actuar."
role: admin
module: inventario
action: view_doc
---

# mwt-admin-inventario-ver-documento

> Skill MCP enfocado: **Admin (CEO)** · **Inventario** · permiso **ver-documento** (ver/listar documentos).
