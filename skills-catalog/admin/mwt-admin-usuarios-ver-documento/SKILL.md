---
name: mwt-admin-usuarios-ver-documento
description: "Rol Admin (CEO) · módulo Usuarios (usuarios) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de usuarios. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/usuarios.md antes de actuar."
role: admin
module: usuarios
action: view_doc
---

# mwt-admin-usuarios-ver-documento

> Skill MCP enfocado: **Admin (CEO)** · **Usuarios** · permiso **ver-documento** (ver/listar documentos).
