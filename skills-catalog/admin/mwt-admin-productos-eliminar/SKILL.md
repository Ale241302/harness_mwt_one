---
name: mwt-admin-productos-eliminar
description: "Rol Admin (CEO) · módulo Productos (productos) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de productos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/productos.md antes de actuar."
role: admin
module: productos
action: delete
---

# mwt-admin-productos-eliminar

> Skill MCP enfocado: **Admin (CEO)** · **Productos** · permiso **eliminar** (eliminar/borrar).

## Propósito
Operar el módulo **Productos** (`productos`) con la acción **eliminar** (eliminar/borrar) usando SOLO
...
- El alcance de este skill es **eliminar** sobre **Productos**; para otra operación activá el SKILL.md correspondiente.
