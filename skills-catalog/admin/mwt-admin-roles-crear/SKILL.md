---
name: mwt-admin-roles-crear
description: "Rol Admin (CEO) · módulo Roles y Permisos (roles) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en roles. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/roles.md antes de actuar."
role: admin
module: roles
action: create
---

# mwt-admin-roles-crear

> Skill MCP enfocado: **Admin (CEO)** · **Roles y Permisos** · permiso **crear** (crear).
