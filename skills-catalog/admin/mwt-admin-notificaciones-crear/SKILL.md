---
name: mwt-admin-notificaciones-crear
description: "Rol Admin (CEO) · módulo Notificaciones (notificaciones) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en notificaciones. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/notificaciones.md antes de actuar."
role: admin
module: notificaciones
action: create
---

# mwt-admin-notificaciones-crear

> Skill MCP enfocado: **Admin (CEO)** · **Notificaciones** · permiso **crear** (crear).
