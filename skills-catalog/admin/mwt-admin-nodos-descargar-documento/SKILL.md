---
name: mwt-admin-nodos-descargar-documento
description: "Rol Admin (CEO) · módulo Nodos (nodos) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de nodos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/nodos.md antes de actuar."
role: admin
module: nodos
action: download_doc
---

# mwt-admin-nodos-descargar-documento

> Skill MCP enfocado: **Admin (CEO)** · **Nodos** · permiso **descargar-documento** (descargar un archivo/documento).
