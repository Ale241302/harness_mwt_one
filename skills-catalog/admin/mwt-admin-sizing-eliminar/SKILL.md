---
name: mwt-admin-sizing-eliminar
description: "Rol Admin (CEO) · módulo Motor de Tallas (sizing) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de sizing. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/sizing.md antes de actuar."
role: admin
module: sizing
action: delete
---

# mwt-admin-sizing-eliminar

> Skill MCP enfocado: **Admin (CEO)** · **Motor de Tallas** · permiso **eliminar** (eliminar/borrar).
