---
name: mwt-admin-inventario-subir-documento
description: "Rol Admin (CEO) · módulo Inventario (inventario) · permiso subir-documento (subir un archivo/documento). Úsala cuando el usuario quiera subir o adjuntar un documento a inventario. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/inventario.md antes de actuar."
role: admin
module: inventario
action: upload_doc
---

# mwt-admin-inventario-subir-documento

> Skill MCP enfocado: **Admin (CEO)** · **Inventario** · permiso **subir-documento** (subir un archivo/documento).
