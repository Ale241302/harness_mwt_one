...
description: "Rol Admin (CEO) · módulo Expedientes (expedientes) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de expedientes. Herramientas MCP: expediente_eliminar, documento_eliminar. Lee el contrato en _contratos/expedientes.md antes de actuar."
role: admin
module: expedientes
action: delete
---

# mwt-admin-expedientes-eliminar

> Skill MCP enfocado: **Admin (CEO)** · **Expedientes** · permiso **eliminar** (eliminar/borrar).
