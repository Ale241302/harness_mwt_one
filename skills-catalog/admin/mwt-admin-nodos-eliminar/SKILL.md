---
name: mwt-admin-nodos-eliminar
description: "Rol Admin (CEO) · módulo Nodos (nodos) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de nodos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/nodos.md antes de actuar."
role: admin
module: nodos
action: delete
---

# mwt-admin-nodos-eliminar

> Skill MCP enfocado: **Admin (CEO)** · **Nodos** · permiso **eliminar** (eliminar/borrar).
