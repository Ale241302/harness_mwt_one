...
description: "Rol Admin (CEO) · módulo Cartera (cartera) · permiso editar (actualizar/modificar). Úsala cuando el usuario quiera editar, actualizar, corregir o cambiar algo en cartera. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/cartera.md antes de actuar."
role: admin
module: cartera
action: update
---

# mwt-admin-cartera-editar

> Skill MCP enfocado: **Admin (CEO)** · **Cartera** · permiso **editar** (actualizar/modificar).
