...
description: "Rol Admin (CEO) · módulo Motor de Tallas (sizing) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de sizing. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/sizing.md antes de actuar."
role: admin
module: sizing
action: view_doc
---

# mwt-admin-sizing-ver-documento

> Skill MCP enfocado: **Admin (CEO)** · **Motor de Tallas** · permiso **ver-documento** (ver/listar documentos).
