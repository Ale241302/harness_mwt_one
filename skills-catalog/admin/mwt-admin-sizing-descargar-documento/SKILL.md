---
name: mwt-admin-sizing-descargar-documento
description: "Rol Admin (CEO) · módulo Motor de Tallas (sizing) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de sizing. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/sizing.md antes de actuar."
role: admin
module: sizing
action: download_doc
---

# mwt-admin-sizing-descargar-documento

> Skill MCP enfocado: **Admin (CEO)** · **Motor de Tallas** · permiso **descargar-documento** (descargar un archivo/documento).
