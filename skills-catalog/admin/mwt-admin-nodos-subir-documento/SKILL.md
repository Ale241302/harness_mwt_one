...
description: "Rol Admin (CEO) · módulo Nodos (nodos) · permiso subir-documento (subir un archivo/documento). Úsala cuando el usuario quiera subir o adjuntar un documento a nodos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/nodos.md antes de actuar."
role: admin
module: nodos
action: upload_doc
---

# mwt-admin-nodos-subir-documento

> Skill MCP enfocado: **Admin (CEO)** · **Nodos** · permiso **subir-documento** (subir un archivo/documento).
