...
description: "Rol Admin (CEO) · módulo Usuarios (usuarios) · permiso subir-documento (subir un archivo/documento). Úsala cuando el usuario quiera subir o adjuntar un documento a usuarios. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/usuarios.md antes de actuar."
role: admin
module: usuarios
action: upload_doc
---

# mwt-admin-usuarios-subir-documento

> Skill MCP enfocado: **Admin (CEO)** · **Usuarios** · permiso **subir-documento** (subir un archivo/documento).
