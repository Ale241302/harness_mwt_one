---
name: mwt-admin-pagos-ver-documento
description: "Rol Admin (CEO) · módulo Pagos (pagos) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de pagos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/pagos.md antes de actuar."
role: admin
module: pagos
action: view_doc
---

# mwt-admin-pagos-ver-documento

> Skill MCP enfocado: **Admin (CEO)** · **Pagos** · permiso **ver-documento** (ver/listar documentos).
