---
name: mwt-admin-sizing-subir-documento
description: "Rol Admin (CEO) · módulo Motor de Tallas (sizing) · permiso subir-documento (subir un archivo/documento). Úsala cuando el usuario quiera subir o adjuntar un documento a sizing. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/sizing.md antes de actuar."
role: admin
module: sizing
action: upload_doc
---

# mwt-admin-sizing-subir-documento

> Skill MCP enfocado: **Admin (CEO)** · **Motor de Tallas** · permiso **subir-documento** (subir un archivo/documento).
