---
name: mwt-admin-historial-precios-crear
description: "Rol Admin (CEO) · módulo Historial de precios (historial-precios) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en historial-precios. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/historial-precios.md antes de actuar."
role: admin
module: historial-precios
action: create
---

# mwt-admin-historial-precios-crear

> Skill MCP enfocado: **Admin (CEO)** · **Historial de precios** · permiso **crear** (crear).
