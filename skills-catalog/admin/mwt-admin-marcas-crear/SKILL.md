---
name: mwt-admin-marcas-crear
description: "Rol Admin (CEO) · módulo Marcas (marcas) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en marcas. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/marcas.md antes de actuar."
role: admin
module: marcas
action: create
---

# mwt-admin-marcas-crear

> Skill MCP enfocado: **Admin (CEO)** · **Marcas** · permiso **crear** (crear).

## Propósito
Operar el módulo **Marcas** (`marcas`) con la acción **crear** (crear) usando SOLO
...
- El alcance de este skill es **crear** sobre **Marcas**; para otra operación activá el SKILL.md correspondiente.
