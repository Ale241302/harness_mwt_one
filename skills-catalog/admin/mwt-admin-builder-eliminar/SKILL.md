...
description: Rol Admin (CEO) · módulo MWT Builder (builder) · permiso eliminar (eliminar/borrar). Herramientas MCP: builder_artefacto_eliminar. Lee el contrato en _contratos/builder.md antes de actuar.
role: admin
module: builder
action: delete
---
