---
name: mwt-admin-builder-eliminar
description: "Rol Admin (CEO) · módulo MWT Builder (builder) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de builder. Herramientas MCP: builder_artefacto_eliminar. Lee el contrato en _contratos/builder.md antes de actuar."
role: admin
module: builder
action: delete
---

# mwt-admin-builder-eliminar

> Skill MCP enfocado: **Admin (CEO)** · **MWT Builder** · permiso **eliminar** (eliminar/borrar).

## Propósito
Operar el módulo **MWT Builder** (`builder`) con la acción **eliminar** (eliminar/borrar) usando SOLO
...
## Herramientas MCP para esta acción
  - `builder_artefacto_eliminar`

## Firmas (cómo invocar)
  - `builder_artefacto_eliminar` → `def builder_artefacto_eliminar(artefacto_id: int) -> Any:`
...
- El alcance de este skill es **eliminar** sobre **MWT Builder**; para otra operación activá el SKILL.md correspondiente.
