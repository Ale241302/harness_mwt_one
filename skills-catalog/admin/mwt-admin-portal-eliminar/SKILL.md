...
description: Rol Admin (CEO) · módulo Portal (portal) · permiso eliminar (eliminar/borrar). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/portal.md antes de actuar.
role: admin
module: portal
action: delete
---
