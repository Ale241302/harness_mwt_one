---
name: mwt-admin-inventario-eliminar
description: "Rol Admin (CEO) · módulo Inventario (inventario) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de inventario. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/inventario.md antes de actuar."
role: admin
module: inventario
action: delete
---

# mwt-admin-inventario-eliminar

> Skill MCP enfocado: **Admin (CEO)** · **Inventario** · permiso **eliminar** (eliminar/borrar).
