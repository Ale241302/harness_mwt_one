---
name: mwt-admin-notificaciones-subir-documento
description: "Rol Admin (CEO) · módulo Notificaciones (notificaciones) · permiso subir-documento (subir un archivo/documento). Úsala cuando el usuario quiera subir o adjuntar un documento a notificaciones. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/notificaciones.md antes de actuar."
role: admin
module: notificaciones
action: upload_doc
---

# mwt-admin-notificaciones-subir-documento

> Skill MCP enfocado: **Admin (CEO)** · **Notificaciones** · permiso **subir-documento** (subir un archivo/documento).
