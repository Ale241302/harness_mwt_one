---
name: mwt-admin-tickets-subir-documento
description: "Rol Admin (CEO) · módulo Tickets (tickets) · permiso subir-documento (subir un archivo/documento). Úsala cuando el usuario quiera subir o adjuntar un documento a tickets. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/tickets.md antes de actuar."
role: admin
module: tickets
action: upload_doc
---

# mwt-admin-tickets-subir-documento

> Skill MCP enfocado: **Admin (CEO)** · **Tickets** · permiso **subir-documento** (subir un archivo/documento).

## Propósito
Operar el módulo **Tickets** (`tickets`) con la acción **subir-documento** (subir un archivo/documento) usando SOLO
...
- El alcance de este skill es **subir-documento** sobre **Tickets**; para otra operación activá el SKILL.md correspondiente.
