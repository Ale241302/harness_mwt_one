...
description: Rol Admin (CEO) · módulo Tickets (tickets) · permiso subir-documento (subir un archivo/documento). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/tickets.md antes de actuar.
role: admin
module: tickets
action: upload_doc
---
