---
name: mwt-admin-cartera-descargar-documento
description: "Rol Admin (CEO) · módulo Cartera (cartera) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de cartera. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/cartera.md antes de actuar."
role: admin
module: cartera
action: download_doc
---

# mwt-admin-cartera-descargar-documento

> Skill MCP enfocado: **Admin (CEO)** · **Cartera** · permiso **descargar-documento** (descargar un archivo/documento).
