---
name: mwt-admin-sizing-crear
description: "Rol Admin (CEO) · módulo Motor de Tallas (sizing) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en sizing. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/sizing.md antes de actuar."
role: admin
module: sizing
action: create
---

# mwt-admin-sizing-crear

> Skill MCP enfocado: **Admin (CEO)** · **Motor de Tallas** · permiso **crear** (crear).
