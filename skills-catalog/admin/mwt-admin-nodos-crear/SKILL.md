...
description: Rol Admin (CEO) · módulo Nodos (nodos) · permiso crear (crear). Herramientas MCP: nodo_crear, nodo_artefacto_crear. Lee el contrato en _contratos/nodos.md antes de actuar.
role: admin
module: nodos
action: create
---
