...
description: "Rol Admin (CEO) · módulo Storage (storage) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en storage. Herramientas MCP: storage_subir_archivo. Lee el contrato en _contratos/storage.md antes de actuar."
role: admin
module: storage
action: create
---

# mwt-admin-storage-crear

> Skill MCP enfocado: **Admin (CEO)** · **Storage** · permiso **crear** (crear).
