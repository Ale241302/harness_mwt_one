---
name: mwt-admin-tickets-ver-documento
description: "Rol Admin (CEO) · módulo Tickets (tickets) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de tickets. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/tickets.md antes de actuar."
role: admin
module: tickets
action: view_doc
---

# mwt-admin-tickets-ver-documento

> Skill MCP enfocado: **Admin (CEO)** · **Tickets** · permiso **ver-documento** (ver/listar documentos).
