---
name: mwt-admin-nodos-editar
description: "Rol Admin (CEO) · módulo Nodos (nodos) · permiso editar (actualizar/modificar). Úsala cuando el usuario quiera editar, actualizar, corregir o cambiar algo en nodos. Herramientas MCP: nodo_editar, artefacto_editar, artefacto_publicar. Lee el contrato en _contratos/nodos.md antes de actuar."
role: admin
module: nodos
action: update
---

# mwt-admin-nodos-editar

> Skill MCP enfocado: **Admin (CEO)** · **Nodos** · permiso **editar** (actualizar/modificar).
