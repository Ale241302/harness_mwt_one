...
description: "Rol Admin (CEO) · módulo Dashboard (dashboard) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en dashboard. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/dashboard.md antes de actuar."
role: admin
module: dashboard
action: create
---
