...
description: "Rol Admin (CEO) · módulo Clientes (clientes) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de clientes. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/clientes.md antes de actuar."
role: admin
module: clientes
action: delete
---

# mwt-admin-clientes-eliminar

> Skill MCP enfocado: **Admin (CEO)** · **Clientes** · permiso **eliminar** (eliminar/borrar).
