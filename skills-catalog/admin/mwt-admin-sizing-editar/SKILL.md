---
name: mwt-admin-sizing-editar
description: "Rol Admin (CEO) · módulo Motor de Tallas (sizing) · permiso editar (actualizar/modificar). Úsala cuando el usuario quiera editar, actualizar, corregir o cambiar algo en sizing. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/sizing.md antes de actuar."
role: admin
module: sizing
action: update
---

# mwt-admin-sizing-editar

> Skill MCP enfocado: **Admin (CEO)** · **Motor de Tallas** · permiso **editar** (actualizar/modificar).

## Propósito
Operar el módulo **Motor de Tallas** (`sizing`) con la acción **editar** (actualizar/modificar) usando SOLO
...
- El alcance de este skill es **editar** sobre **Motor de Tallas**; para otra operación activá el SKILL.md correspondiente.
