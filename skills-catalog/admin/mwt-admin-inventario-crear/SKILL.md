---
name: mwt-admin-inventario-crear
description: "Rol Admin (CEO) · módulo Inventario (inventario) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en inventario. Herramientas MCP: recepcion_crear. Lee el contrato en _contratos/inventario.md antes de actuar."
role: admin
module: inventario
action: create
---

# mwt-admin-inventario-crear

> Skill MCP enfocado: **Admin (CEO)** · **Inventario** · permiso **crear** (crear).
