---
name: mwt-admin-usuarios-editar
description: "Rol Admin (CEO) · módulo Usuarios (usuarios) · permiso editar (actualizar/modificar). Úsala cuando el usuario quiera editar, actualizar, corregir o cambiar algo en usuarios. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/usuarios.md antes de actuar."
role: admin
module: usuarios
action: update
---

# mwt-admin-usuarios-editar

> Skill MCP enfocado: **Admin (CEO)** · **Usuarios** · permiso **editar** (actualizar/modificar).

## Propósito
Operar el módulo **Usuarios** (`usuarios`) con la acción **editar** (actualizar/modificar) usando SOLO
...
- El alcance de este skill es **editar** sobre **Usuarios**; para otra operación activá el SKILL.md correspondiente.
