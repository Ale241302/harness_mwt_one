---
name: mwt-admin-storage-editar
description: "Rol Admin (CEO) · módulo Storage (storage) · permiso editar (actualizar/modificar). Úsala cuando el usuario quiera editar, actualizar, corregir o cambiar algo en storage. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/storage.md antes de actuar."
role: admin
module: storage
action: update
---

# mwt-admin-storage-editar

> Skill MCP enfocado: **Admin (CEO)** · **Storage** · permiso **editar** (actualizar/modificar).
