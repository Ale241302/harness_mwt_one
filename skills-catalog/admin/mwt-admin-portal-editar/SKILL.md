...
description: "Rol Admin (CEO) · módulo Portal (portal) · permiso editar (actualizar/modificar). Úsala cuando el usuario quiera editar, actualizar, corregir o cambiar algo en portal. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/portal.md antes de actuar."
role: admin
module: portal
action: update
---

# mwt-admin-portal-editar

> Skill MCP enfocado: **Admin (CEO)** · **Portal** · permiso **editar** (actualizar/modificar).
