---
name: mwt-admin-notificaciones-descargar-documento
description: Rol Admin (CEO) · módulo Notificaciones (notificaciones) · permiso descargar-documento (descargar un archivo/documento). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/notificaciones.md antes de actuar.
role: admin
module: notificaciones
action: download_doc
---

# mwt-admin-notificaciones-descargar-documento

> Skill MCP enfocado: **Admin (CEO)** · **Notificaciones** · permiso **descargar-documento** (descargar un archivo/documento).
