...
description: "Rol Admin (CEO) · módulo Roles y Permisos (roles) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de roles. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/roles.md antes de actuar."
role: admin
module: roles
action: delete
---

# mwt-admin-roles-eliminar

> Skill MCP enfocado: **Admin (CEO)** · **Roles y Permisos** · permiso **eliminar** (eliminar/borrar).
