...
description: "Rol Admin (CEO) · módulo Pagos (pagos) · permiso subir-documento (subir un archivo/documento). Úsala cuando el usuario quiera subir o adjuntar un documento a pagos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/pagos.md antes de actuar."
role: admin
module: pagos
action: upload_doc
---

# mwt-admin-pagos-subir-documento

> Skill MCP enfocado: **Admin (CEO)** · **Pagos** · permiso **subir-documento** (subir un archivo/documento).

## Propósito
Operar el módulo **Pagos** (`pagos`) con la acción **subir-documento** (subir un archivo/documento) usando SOLO
...
- El alcance de este skill es **subir-documento** sobre **Pagos**; para otra operación activá el SKILL.md correspondiente.
