---
name: mwt-admin-portal-ver-documento
description: "Rol Admin (CEO) · módulo Portal (portal) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de portal. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/portal.md antes de actuar."
role: admin
module: portal
action: view_doc
---

# mwt-admin-portal-ver-documento

> Skill MCP enfocado: **Admin (CEO)** · **Portal** · permiso **ver-documento** (ver/listar documentos).
