---
name: mwt-admin-productos-ver-documento
description: "Rol Admin (CEO) · módulo Productos (productos) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de productos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/productos.md antes de actuar."
role: admin
module: productos
action: view_doc
---

# mwt-admin-productos-ver-documento

> Skill MCP enfocado: **Admin (CEO)** · **Productos** · permiso **ver-documento** (ver/listar documentos).
