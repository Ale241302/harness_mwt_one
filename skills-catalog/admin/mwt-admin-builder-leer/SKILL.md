...
description: "Rol Admin (CEO) · módulo MWT Builder (builder) · permiso leer (consultar/listar). Úsala cuando el usuario quiera consultar, listar, ver, buscar o revisar builder (por ejemplo 'muéstrame builder' o 'busca en builder'). Herramientas MCP: builder_structure_construir, builder_artefacto_listar, builder_artefacto_obtener. Lee el contrato en _contratos/builder.md antes de actuar."
role: admin
module: builder
action: view
---

# mwt-admin-builder-leer

> Skill MCP enfocado: **Admin (CEO)** · **MWT Builder** · permiso **leer** (consultar/listar).
