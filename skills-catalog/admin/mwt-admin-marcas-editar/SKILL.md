---
name: mwt-admin-marcas-editar
description: "Rol Admin (CEO) · módulo Marcas (marcas) · permiso editar (actualizar/modificar). Úsala cuando el usuario quiera editar, actualizar, corregir o cambiar algo en marcas. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/marcas.md antes de actuar."
role: admin
module: marcas
action: update
---

# mwt-admin-marcas-editar

> Skill MCP enfocado: **Admin (CEO)** · **Marcas** · permiso **editar** (actualizar/modificar).
