---
name: mwt-admin-usuarios-descargar-documento
description: "Rol Admin (CEO) · módulo Usuarios (usuarios) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de usuarios. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/usuarios.md antes de actuar."
role: admin
module: usuarios
action: download_doc
---

# mwt-admin-usuarios-descargar-documento

> Skill MCP enfocado: **Admin (CEO)** · **Usuarios** · permiso **descargar-documento** (descargar un archivo/documento).
