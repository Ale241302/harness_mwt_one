---
name: mwt-superadmin-inventario-leer
description: "Rol Super Admin · módulo Inventario (inventario) · permiso leer (consultar/listar). Úsala cuando el usuario quiera consultar, listar, ver, buscar o revisar inventario (por ejemplo 'muéstrame inventario' o 'busca en inventario'). Herramientas MCP: stock_listar, inventario_saldos_por_expediente, inventario_expedientes_con_pendiente, inventario_lineas_en_nodo, inventario_artefactos_expediente. Lee el contrato en _contratos/inventario.md antes de actuar."
role: superadmin
module: inventario
action: view
---

# mwt-superadmin-inventario-leer

> Skill MCP enfocado: **Super Admin** · **Inventario** · permiso **leer** (consultar/listar).
