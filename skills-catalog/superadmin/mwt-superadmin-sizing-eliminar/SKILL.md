...
description: "Rol Super Admin · módulo Motor de Tallas (sizing) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de sizing. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/sizing.md antes de actuar."
role: superadmin
module: sizing
action: delete
---

# mwt-superadmin-sizing-eliminar

> Skill MCP enfocado: **Super Admin** · **Motor de Tallas** · permiso **eliminar** (eliminar/borrar).
