---
name: mwt-superadmin-marcas-ver-documento
description: "Rol Super Admin · módulo Marcas (marcas) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de marcas. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/marcas.md antes de actuar."
role: superadmin
module: marcas
action: view_doc
---

# mwt-superadmin-marcas-ver-documento

> Skill MCP enfocado: **Super Admin** · **Marcas** · permiso **ver-documento** (ver/listar documentos).

## Propósito
Operar el módulo **Marcas** (`marcas`) con la acción **ver-documento** (ver/listar documentos) usando SOLO
...
- El alcance de este skill es **ver-documento** sobre **Marcas**; para otra operación activá el SKILL.md correspondiente.
