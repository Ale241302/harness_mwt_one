...
description: Rol Super Admin · módulo Marcas (marcas) · permiso ver-documento (ver/listar documentos). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/marcas.md antes de actuar.
role: superadmin
module: marcas
action: view_doc
---
