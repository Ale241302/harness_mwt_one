---
name: mwt-superadmin-clientes-subir-documento
description: "Rol Super Admin · módulo Clientes (clientes) · permiso subir-documento (subir un archivo/documento). Úsala cuando el usuario quiera subir o adjuntar un documento a clientes. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/clientes.md antes de actuar."
role: superadmin
module: clientes
action: upload_doc
---

# mwt-superadmin-clientes-subir-documento

> Skill MCP enfocado: **Super Admin** · **Clientes** · permiso **subir-documento** (subir un archivo/documento).

## Propósito
Operar el módulo **Clientes** (`clientes`) con la acción **subir-documento** (subir un archivo/documento) usando SOLO
...
- El alcance de este skill es **subir-documento** sobre **Clientes**; para otra operación activá el SKILL.md correspondiente.
