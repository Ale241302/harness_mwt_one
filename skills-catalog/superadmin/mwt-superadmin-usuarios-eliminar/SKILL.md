---
name: mwt-superadmin-usuarios-eliminar
description: "Rol Super Admin · módulo Usuarios (usuarios) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de usuarios. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/usuarios.md antes de actuar."
role: superadmin
module: usuarios
action: delete
---

# mwt-superadmin-usuarios-eliminar

> Skill MCP enfocado: **Super Admin** · **Usuarios** · permiso **eliminar** (eliminar/borrar).

## Propósito
Operar el módulo **Usuarios** (`usuarios`) con la acción **eliminar** (eliminar/borrar) usando SOLO
...
- El alcance de este skill es **eliminar** sobre **Usuarios**; para otra operación activá el SKILL.md correspondiente.
