---
name: mwt-superadmin-cartera-ver-documento
description: "Rol Super Admin · módulo Cartera (cartera) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de cartera. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/cartera.md antes de actuar."
role: superadmin
module: cartera
action: view_doc
---

# mwt-superadmin-cartera-ver-documento

> Skill MCP enfocado: **Super Admin** · **Cartera** · permiso **ver-documento** (ver/listar documentos).
