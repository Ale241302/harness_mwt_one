---
name: mwt-superadmin-marcas-editar
description: "Rol Super Admin · módulo Marcas (marcas) · permiso editar (actualizar/modificar). Úsala cuando el usuario quiera editar, actualizar, corregir o cambiar algo en marcas. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/marcas.md antes de actuar."
role: superadmin
module: marcas
action: update
---

# mwt-superadmin-marcas-editar

> Skill MCP enfocado: **Super Admin** · **Marcas** · permiso **editar** (actualizar/modificar).

## Propósito
Operar el módulo **Marcas** (`marcas`) con la acción **editar** (actualizar/modificar) usando SOLO
...
- El alcance de este skill es **editar** sobre **Marcas**; para otra operación activá el SKILL.md correspondiente.
