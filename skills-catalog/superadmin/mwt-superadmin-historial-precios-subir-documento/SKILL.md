---
name: mwt-superadmin-historial-precios-subir-documento
description: Rol Super Admin · módulo Historial de precios (historial-precios) · permiso subir-documento (subir un archivo/documento). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/historial-precios.md antes de actuar.
role: superadmin
module: historial-precios
action: upload_doc
---

# mwt-superadmin-historial-precios-subir-documento

> Skill MCP enfocado: **Super Admin** · **Historial de precios** · permiso **subir-documento** (subir un archivo/documento).

## Propósito
Operar el módulo **Historial de precios** (`historial-precios`) con la acción **subir-documento** (subir un archivo/documento) usando SOLO
...
- El alcance de este skill es **subir-documento** sobre **Historial de precios**; para otra operación activá el SKILL.md correspondiente.
