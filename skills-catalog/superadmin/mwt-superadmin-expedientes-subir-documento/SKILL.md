...
description: Rol Super Admin · módulo Expedientes (expedientes) · permiso subir-documento (subir un archivo/documento). Herramientas MCP: documento_subir, match_subir. Lee el contrato en _contratos/expedientes.md antes de actuar.
role: superadmin
module: expedientes
action: upload_doc
---
