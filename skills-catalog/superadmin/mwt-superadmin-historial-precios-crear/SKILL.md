---
name: mwt-superadmin-historial-precios-crear
description: "Rol Super Admin · módulo Historial de precios (historial-precios) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en historial-precios. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/historial-precios.md antes de actuar."
role: superadmin
module: historial-precios
action: create
---

# mwt-superadmin-historial-precios-crear

> Skill MCP enfocado: **Super Admin** · **Historial de precios** · permiso **crear** (crear).

## Propósito
Operar el módulo **Historial de precios** (`historial-precios`) con la acción **crear** (crear) usando SOLO
...
- El alcance de este skill es **crear** sobre **Historial de precios**; para otra operación activá el SKILL.md correspondiente.
