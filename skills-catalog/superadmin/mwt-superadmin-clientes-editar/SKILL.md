---
name: mwt-superadmin-clientes-editar
description: "Rol Super Admin · módulo Clientes (clientes) · permiso editar (actualizar/modificar). Úsala cuando el usuario quiera editar, actualizar, corregir o cambiar algo en clientes. Herramientas MCP: cliente_editar. Lee el contrato en _contratos/clientes.md antes de actuar."
role: superadmin
module: clientes
action: update
---

# mwt-superadmin-clientes-editar

> Skill MCP enfocado: **Super Admin** · **Clientes** · permiso **editar** (actualizar/modificar).
