...
description: "Rol Super Admin · módulo Cartera (cartera) · permiso editar (actualizar/modificar). Úsala cuando el usuario quiera editar, actualizar, corregir o cambiar algo en cartera. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/cartera.md antes de actuar."
role: superadmin
module: cartera
action: update
---

# mwt-superadmin-cartera-editar

> Skill MCP enfocado: **Super Admin** · **Cartera** · permiso **editar** (actualizar/modificar).
