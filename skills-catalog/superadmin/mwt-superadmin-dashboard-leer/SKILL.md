---
name: mwt-superadmin-dashboard-leer
description: Rol Super Admin · módulo Dashboard (dashboard) · permiso leer (consultar/listar). Herramientas MCP: generar_grafico, render_tabla, generar_reporte, comparar, exportar_xlsx, exportar_csv. Lee el contrato en _contratos/dashboard.md antes de actuar.
role: superadmin
module: dashboard
action: view
---

# mwt-superadmin-dashboard-leer

> Skill MCP enfocado: **Super Admin** · **Dashboard** · permiso **leer** (consultar/listar).
