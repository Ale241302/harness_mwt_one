...
description: "Rol Super Admin · módulo Portal (portal) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de portal. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/portal.md antes de actuar."
role: superadmin
module: portal
action: view_doc
---

# mwt-superadmin-portal-ver-documento

> Skill MCP enfocado: **Super Admin** · **Portal** · permiso **ver-documento** (ver/listar documentos).
