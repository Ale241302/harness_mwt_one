---
name: mwt-superadmin-roles-descargar-documento
description: "Rol Super Admin · módulo Roles y Permisos (roles) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de roles. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/roles.md antes de actuar."
role: superadmin
module: roles
action: download_doc
---

# mwt-superadmin-roles-descargar-documento

> Skill MCP enfocado: **Super Admin** · **Roles y Permisos** · permiso **descargar-documento** (descargar un archivo/documento).

## Propósito
Operar el módulo **Roles y Permisos** (`roles`) con la acción **descargar-documento** (descargar un archivo/documento) usando SOLO
...
- El alcance de este skill es **descargar-documento** sobre **Roles y Permisos**; para otra operación activá el SKILL.md correspondiente.
