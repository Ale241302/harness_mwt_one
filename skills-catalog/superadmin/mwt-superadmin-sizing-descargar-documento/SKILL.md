---
name: mwt-superadmin-sizing-descargar-documento
description: "Rol Super Admin · módulo Motor de Tallas (sizing) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de sizing. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/sizing.md antes de actuar."
role: superadmin
module: sizing
action: download_doc
---

# mwt-superadmin-sizing-descargar-documento

> Skill MCP enfocado: **Super Admin** · **Motor de Tallas** · permiso **descargar-documento** (descargar un archivo/documento).
