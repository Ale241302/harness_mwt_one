---
name: mwt-superadmin-builder-crear
description: "Rol Super Admin · módulo MWT Builder (builder) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en builder. Herramientas MCP: builder_artefacto_crear. Lee el contrato en _contratos/builder.md antes de actuar."
role: superadmin
module: builder
action: create
---

# mwt-superadmin-builder-crear

> Skill MCP enfocado: **Super Admin** · **MWT Builder** · permiso **crear** (crear).

## Propósito
Operar el módulo **MWT Builder** (`builder`) con la acción **crear** (crear) usando SOLO
...
## Herramientas MCP para esta acción
  - `builder_artefacto_crear` — `title`: nombre de la plantilla (ej. "ART-05: AWB/BL").

## Firmas (cómo invocar)
  - `builder_artefacto_crear` → `def builder_artefacto_crear(title: str, secciones: list, status: str = "Published") -> Any:`
...
- El alcance de este skill es **crear** sobre **MWT Builder**; para otra operación activá el SKILL.md correspondiente.
