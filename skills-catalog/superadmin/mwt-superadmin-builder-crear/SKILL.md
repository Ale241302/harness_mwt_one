...
description: Rol Super Admin · módulo MWT Builder (builder) · permiso crear (crear). Herramientas MCP: builder_artefacto_crear. Lee el contrato en _contratos/builder.md antes de actuar.
role: superadmin
module: builder
action: create
---
