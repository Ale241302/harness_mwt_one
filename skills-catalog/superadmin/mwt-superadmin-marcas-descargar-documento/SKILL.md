---
name: mwt-superadmin-marcas-descargar-documento
description: "Rol Super Admin · módulo Marcas (marcas) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de marcas. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/marcas.md antes de actuar."
role: superadmin
module: marcas
action: download_doc
---

# mwt-superadmin-marcas-descargar-documento

> Skill MCP enfocado: **Super Admin** · **Marcas** · permiso **descargar-documento** (descargar un archivo/documento).
