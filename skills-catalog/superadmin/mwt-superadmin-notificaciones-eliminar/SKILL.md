---
name: mwt-superadmin-notificaciones-eliminar
description: "Rol Super Admin · módulo Notificaciones (notificaciones) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de notificaciones. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/notificaciones.md antes de actuar."
role: superadmin
module: notificaciones
action: delete
---

# mwt-superadmin-notificaciones-eliminar

> Skill MCP enfocado: **Super Admin** · **Notificaciones** · permiso **eliminar** (eliminar/borrar).

## Propósito
Operar el módulo **Notificaciones** (`notificaciones`) con la acción **eliminar** (eliminar/borrar) usando SOLO
...
- El alcance de este skill es **eliminar** sobre **Notificaciones**; para otra operación activá el SKILL.md correspondiente.
