...
description: "Rol Super Admin · módulo Nodos (nodos) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de nodos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/nodos.md antes de actuar."
role: superadmin
module: nodos
action: delete
---

# mwt-superadmin-nodos-eliminar

> Skill MCP enfocado: **Super Admin** · **Nodos** · permiso **eliminar** (eliminar/borrar).
