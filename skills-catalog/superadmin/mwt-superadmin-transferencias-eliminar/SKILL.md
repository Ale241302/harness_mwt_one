...
description: "Rol Super Admin · módulo Transferencias (transferencias) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de transferencias. Herramientas MCP: transfer_costo_eliminar. Lee el contrato en _contratos/transferencias.md antes de actuar."
role: superadmin
