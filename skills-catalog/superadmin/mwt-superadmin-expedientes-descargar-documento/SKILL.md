---
name: mwt-superadmin-expedientes-descargar-documento
description: "Rol Super Admin · módulo Expedientes (expedientes) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de expedientes. Herramientas MCP: documento_descargar. Lee el contrato en _contratos/expedientes.md antes de actuar."
role: superadmin
module: expedientes
action: download_doc
---

# mwt-superadmin-expedientes-descargar-documento

> Skill MCP enfocado: **Super Admin** · **Expedientes** · permiso **descargar-documento** (descargar un archivo/documento).
