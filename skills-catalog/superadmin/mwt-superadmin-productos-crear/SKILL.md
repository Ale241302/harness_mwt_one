---
name: mwt-superadmin-productos-crear
description: "Rol Super Admin · módulo Productos (productos) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en productos. Herramientas MCP: producto_crear, producto_alias_crear. Lee el contrato en _contratos/productos.md antes de actuar."
role: superadmin
module: productos
action: create
---

# mwt-superadmin-productos-crear

> Skill MCP enfocado: **Super Admin** · **Productos** · permiso **crear** (crear).
