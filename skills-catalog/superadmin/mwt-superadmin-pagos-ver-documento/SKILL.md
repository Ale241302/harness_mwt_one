...
description: "Rol Super Admin · módulo Pagos (pagos) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de pagos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/pagos.md antes de actuar."
role: superadmin
module: pagos
action: view_doc
---

# mwt-superadmin-pagos-ver-documento

> Skill MCP enfocado: **Super Admin** · **Pagos** · permiso **ver-documento** (ver/listar documentos).
