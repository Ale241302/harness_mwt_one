...
description: "Rol Super Admin · módulo Pagos (pagos) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de pagos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/pagos.md antes de actuar."
role: superadmin
module: pagos
action: delete
---

# mwt-superadmin-pagos-eliminar

> Skill MCP enfocado: **Super Admin** · **Pagos** · permiso **eliminar** (eliminar/borrar).

## Propósito
Operar el módulo **Pagos** (`pagos`) con la acción **eliminar** (eliminar/borrar) usando SOLO
...
- El alcance de este skill es **eliminar** sobre **Pagos**; para otra operación activá el SKILL.md correspondiente.
