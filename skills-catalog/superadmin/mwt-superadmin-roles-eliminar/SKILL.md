...
description: "Rol Super Admin · módulo Roles y Permisos (roles) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de roles. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/roles.md antes de actuar."
role: superadmin
module: roles
action: delete
---

# mwt-superadmin-roles-eliminar

> Skill MCP enfocado: **Super Admin** · **Roles y Permisos** · permiso **eliminar** (eliminar/borrar).
