---
name: mwt-superadmin-usuarios-descargar-documento
description: "Rol Super Admin · módulo Usuarios (usuarios) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de usuarios. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/usuarios.md antes de actuar."
role: superadmin
module: usuarios
action: download_doc
---

# mwt-superadmin-usuarios-descargar-documento

> Skill MCP enfocado: **Super Admin** · **Usuarios** · permiso **descargar-documento** (descargar un archivo/documento).

## Propósito
Operar el módulo **Usuarios** (`usuarios`) con la acción **descargar-documento** (descargar un archivo/documento) usando SOLO
...
- El alcance de este skill es **descargar-documento** sobre **Usuarios**; para otra operación activá el SKILL.md correspondiente.
