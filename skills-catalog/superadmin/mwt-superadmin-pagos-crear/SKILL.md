...
description: "Rol Super Admin · módulo Pagos (pagos) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en pagos. Herramientas MCP: pago_dry_run, pago_registrar. Lee el contrato en _contratos/pagos.md antes de actuar."
role: superadmin
module: pagos
action: create
---

# mwt-superadmin-pagos-crear

> Skill MCP enfocado: **Super Admin** · **Pagos** · permiso **crear** (crear).
