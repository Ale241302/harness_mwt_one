---
name: mwt-superadmin-notificaciones-editar
description: Rol Super Admin · módulo Notificaciones (notificaciones) · permiso editar (actualizar/modificar). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/notificaciones.md antes de actuar.
role: superadmin
module: notificaciones
action: update
---

# mwt-superadmin-notificaciones-editar

> Skill MCP enfocado: **Super Admin** · **Notificaciones** · permiso **editar** (actualizar/modificar).

## Propósito
Operar el módulo **Notificaciones** (`notificaciones`) con la acción **editar** (actualizar/modificar) usando SOLO
...
- El alcance de este skill es **editar** sobre **Notificaciones**; para otra operación activá el SKILL.md correspondiente.
