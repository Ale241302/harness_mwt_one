---
name: mwt-superadmin-dashboard-eliminar
description: "Rol Super Admin · módulo Dashboard (dashboard) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de dashboard. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/dashboard.md antes de actuar."
role: superadmin
module: dashboard
action: delete
---

# mwt-superadmin-dashboard-eliminar

> Skill MCP enfocado: **Super Admin** · **Dashboard** · permiso **eliminar** (eliminar/borrar).

## Propósito
Operar el módulo **Dashboard** (`dashboard`) con la acción **eliminar** (eliminar/borrar) usando SOLO
...
- El alcance de este skill es **eliminar** sobre **Dashboard**; para otra operación activá el SKILL.md correspondiente.
