---
name: mwt-superadmin-inventario-subir-documento
description: "Rol Super Admin · módulo Inventario (inventario) · permiso subir-documento (subir un archivo/documento). Úsala cuando el usuario quiera subir o adjuntar un documento a inventario. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/inventario.md antes de actuar."
role: superadmin
module: inventario
action: upload_doc
---

# mwt-superadmin-inventario-subir-documento

> Skill MCP enfocado: **Super Admin** · **Inventario** · permiso **subir-documento** (subir un archivo/documento).

## Propósito
Operar el módulo **Inventario** (`inventario`) con la acción **subir-documento** (subir un archivo/documento) usando SOLO
...
- El alcance de este skill es **subir-documento** sobre **Inventario**; para otra operación activá el SKILL.md correspondiente.
