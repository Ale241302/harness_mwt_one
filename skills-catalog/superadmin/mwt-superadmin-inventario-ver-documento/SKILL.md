...
description: "Rol Super Admin · módulo Inventario (inventario) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de inventario. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/inventario.md antes de actuar."
role: superadmin
module: inventario
action: view_doc
---

# mwt-superadmin-inventario-ver-documento

> Skill MCP enfocado: **Super Admin** · **Inventario** · permiso **ver-documento** (ver/listar documentos).
