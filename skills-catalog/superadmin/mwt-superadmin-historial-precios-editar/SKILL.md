---
name: mwt-superadmin-historial-precios-editar
description: Rol Super Admin · módulo Historial de precios (historial-precios) · permiso editar (actualizar/modificar). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/historial-precios.md antes de actuar.
role: superadmin
module: historial-precios
action: update
---

# mwt-superadmin-historial-precios-editar

> Skill MCP enfocado: **Super Admin** · **Historial de precios** · permiso **editar** (actualizar/modificar).

## Propósito
Operar el módulo **Historial de precios** (`historial-precios`) con la acción **editar** (actualizar/modificar) usando SOLO
...
- El alcance de este skill es **editar** sobre **Historial de precios**; para otra operación activá el SKILL.md correspondiente.
