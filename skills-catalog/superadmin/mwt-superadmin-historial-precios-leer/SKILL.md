---
name: mwt-superadmin-historial-precios-leer
description: Rol Super Admin · módulo Historial de precios (historial-precios) · permiso leer (consultar/listar). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/historial-precios.md antes de actuar.
role: superadmin
module: historial-precios
action: view
---

# mwt-superadmin-historial-precios-leer

> Skill MCP enfocado: **Super Admin** · **Historial de precios** · permiso **leer** (consultar/listar).

## Propósito
Operar el módulo **Historial de precios** (`historial-precios`) con la acción **leer** (consultar/listar) usando SOLO
...
- El alcance de este skill es **leer** sobre **Historial de precios**; para otra operación activá el SKILL.md correspondiente.
