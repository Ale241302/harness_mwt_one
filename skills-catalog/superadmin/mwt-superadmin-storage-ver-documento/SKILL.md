...
description: "Rol Super Admin · módulo Storage (storage) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de storage. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/storage.md antes de actuar."
role: superadmin
module: storage
action: view_doc
---

# mwt-superadmin-storage-ver-documento

> Skill MCP enfocado: **Super Admin** · **Storage** · permiso **ver-documento** (ver/listar documentos).
