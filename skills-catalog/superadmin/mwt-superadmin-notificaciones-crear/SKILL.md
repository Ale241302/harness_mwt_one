---
name: mwt-superadmin-notificaciones-crear
description: "Rol Super Admin · módulo Notificaciones (notificaciones) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en notificaciones. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/notificaciones.md antes de actuar."
role: superadmin
module: notificaciones
action: create
---

# mwt-superadmin-notificaciones-crear

> Skill MCP enfocado: **Super Admin** · **Notificaciones** · permiso **crear** (crear).

## Propósito
Operar el módulo **Notificaciones** (`notificaciones`) con la acción **crear** (crear) usando SOLO
...
- El alcance de este skill es **crear** sobre **Notificaciones**; para otra operación activá el SKILL.md correspondiente.
