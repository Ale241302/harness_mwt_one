...
description: "Rol Super Admin · módulo Marcas (marcas) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en marcas. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/marcas.md antes de actuar."
role: superadmin
module: marcas
action: create
---

# mwt-superadmin-marcas-crear

> Skill MCP enfocado: **Super Admin** · **Marcas** · permiso **crear** (crear).
