---
name: mwt-superadmin-clientes-eliminar
description: "Rol Super Admin · módulo Clientes (clientes) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de clientes. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/clientes.md antes de actuar."
role: superadmin
module: clientes
action: delete
---

# mwt-superadmin-clientes-eliminar

> Skill MCP enfocado: **Super Admin** · **Clientes** · permiso **eliminar** (eliminar/borrar).

## Propósito
Operar el módulo **Clientes** (`clientes`) con la acción **eliminar** (eliminar/borrar) usando SOLO
...
- El alcance de este skill es **eliminar** sobre **Clientes**; para otra operación activá el SKILL.md correspondiente.
