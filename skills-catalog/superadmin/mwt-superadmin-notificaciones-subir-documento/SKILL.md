---
name: mwt-superadmin-notificaciones-subir-documento
description: Rol Super Admin · módulo Notificaciones (notificaciones) · permiso subir-documento (subir un archivo/documento). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/notificaciones.md antes de actuar.
role: superadmin
module: notificaciones
action: upload_doc
---

# mwt-superadmin-notificaciones-subir-documento

> Skill MCP enfocado: **Super Admin** · **Notificaciones** · permiso **subir-documento** (subir un archivo/documento).
