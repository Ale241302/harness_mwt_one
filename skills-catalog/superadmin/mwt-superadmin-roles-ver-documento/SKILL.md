---
name: mwt-superadmin-roles-ver-documento
description: "Rol Super Admin · módulo Roles y Permisos (roles) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de roles. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/roles.md antes de actuar."
role: superadmin
module: roles
action: view_doc
---

# mwt-superadmin-roles-ver-documento

> Skill MCP enfocado: **Super Admin** · **Roles y Permisos** · permiso **ver-documento** (ver/listar documentos).

## Propósito
Operar el módulo **Roles y Permisos** (`roles`) con la acción **ver-documento** (ver/listar documentos) usando SOLO
...
- El alcance de este skill es **ver-documento** sobre **Roles y Permisos**; para otra operación activá el SKILL.md correspondiente.
