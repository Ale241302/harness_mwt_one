---
name: mwt-superadmin-sizing-ver-documento
description: "Rol Super Admin · módulo Motor de Tallas (sizing) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de sizing. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/sizing.md antes de actuar."
role: superadmin
module: sizing
action: view_doc
---

# mwt-superadmin-sizing-ver-documento

> Skill MCP enfocado: **Super Admin** · **Motor de Tallas** · permiso **ver-documento** (ver/listar documentos).

## Propósito
Operar el módulo **Motor de Tallas** (`sizing`) con la acción **ver-documento** (ver/listar documentos) usando SOLO
...
- El alcance de este skill es **ver-documento** sobre **Motor de Tallas**; para otra operación activá el SKILL.md correspondiente.
