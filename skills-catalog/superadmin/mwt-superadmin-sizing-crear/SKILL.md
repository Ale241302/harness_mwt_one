---
name: mwt-superadmin-sizing-crear
description: "Rol Super Admin · módulo Motor de Tallas (sizing) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en sizing. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/sizing.md antes de actuar."
role: superadmin
module: sizing
action: create
---

# mwt-superadmin-sizing-crear

> Skill MCP enfocado: **Super Admin** · **Motor de Tallas** · permiso **crear** (crear).

## Propósito
Operar el módulo **Motor de Tallas** (`sizing`) con la acción **crear** (crear) usando SOLO
...
- El alcance de este skill es **crear** sobre **Motor de Tallas**; para otra operación activá el SKILL.md correspondiente.
