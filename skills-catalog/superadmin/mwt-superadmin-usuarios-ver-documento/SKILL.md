---
name: mwt-superadmin-usuarios-ver-documento
description: "Rol Super Admin · módulo Usuarios (usuarios) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de usuarios. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/usuarios.md antes de actuar."
role: superadmin
module: usuarios
action: view_doc
---

# mwt-superadmin-usuarios-ver-documento

> Skill MCP enfocado: **Super Admin** · **Usuarios** · permiso **ver-documento** (ver/listar documentos).
