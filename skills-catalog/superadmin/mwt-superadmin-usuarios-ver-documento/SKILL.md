...
description: Rol Super Admin · módulo Usuarios (usuarios) · permiso ver-documento (ver/listar documentos). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/usuarios.md antes de actuar.
role: superadmin
module: usuarios
action: view_doc
---
