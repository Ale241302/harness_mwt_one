---
name: mwt-superadmin-nodos-crear
description: "Rol Super Admin · módulo Nodos (nodos) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en nodos. Herramientas MCP: nodo_crear, nodo_artefacto_crear. Lee el contrato en _contratos/nodos.md antes de actuar."
role: superadmin
module: nodos
action: create
---

# mwt-superadmin-nodos-crear

> Skill MCP enfocado: **Super Admin** · **Nodos** · permiso **crear** (crear).
