---
name: mwt-superadmin-roles-crear
description: "Rol Super Admin · módulo Roles y Permisos (roles) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en roles. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/roles.md antes de actuar."
role: superadmin
module: roles
action: create
---

# mwt-superadmin-roles-crear

> Skill MCP enfocado: **Super Admin** · **Roles y Permisos** · permiso **crear** (crear).

## Propósito
Operar el módulo **Roles y Permisos** (`roles`) con la acción **crear** (crear) usando SOLO
...
- El alcance de este skill es **crear** sobre **Roles y Permisos**; para otra operación activá el SKILL.md correspondiente.
