...
description: Rol Super Admin · módulo Transferencias (transferencias) · permiso descargar-documento (descargar un archivo/documento). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/transferencias.md antes de actuar.
role: superadmin
