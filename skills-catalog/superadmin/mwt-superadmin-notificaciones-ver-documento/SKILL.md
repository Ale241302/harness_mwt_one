---
name: mwt-superadmin-notificaciones-ver-documento
description: Rol Super Admin · módulo Notificaciones (notificaciones) · permiso ver-documento (ver/listar documentos). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/notificaciones.md antes de actuar.
role: superadmin
module: notificaciones
action: view_doc
---

# mwt-superadmin-notificaciones-ver-documento

> Skill MCP enfocado: **Super Admin** · **Notificaciones** · permiso **ver-documento** (ver/listar documentos).
