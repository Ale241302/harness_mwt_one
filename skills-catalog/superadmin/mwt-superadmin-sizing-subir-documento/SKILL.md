---
name: mwt-superadmin-sizing-subir-documento
description: "Rol Super Admin · módulo Motor de Tallas (sizing) · permiso subir-documento (subir un archivo/documento). Úsala cuando el usuario quiera subir o adjuntar un documento a sizing. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/sizing.md antes de actuar."
role: superadmin
module: sizing
action: upload_doc
---

# mwt-superadmin-sizing-subir-documento

> Skill MCP enfocado: **Super Admin** · **Motor de Tallas** · permiso **subir-documento** (subir un archivo/documento).

## Propósito
Operar el módulo **Motor de Tallas** (`sizing`) con la acción **subir-documento** (subir un archivo/documento) usando SOLO
...
- El alcance de este skill es **subir-documento** sobre **Motor de Tallas**; para otra operación activá el SKILL.md correspondiente.
