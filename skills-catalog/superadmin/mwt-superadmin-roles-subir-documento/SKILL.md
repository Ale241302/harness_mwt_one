...
description: "Rol Super Admin · módulo Roles y Permisos (roles) · permiso subir-documento (subir un archivo/documento). Úsala cuando el usuario quiera subir o adjuntar un documento a roles. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/roles.md antes de actuar."
role: superadmin
module: roles
action: upload_doc
---

# mwt-superadmin-roles-subir-documento

> Skill MCP enfocado: **Super Admin** · **Roles y Permisos** · permiso **subir-documento** (subir un archivo/documento).
