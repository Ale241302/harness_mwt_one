---
name: mwt-superadmin-storage-editar
description: "Rol Super Admin · módulo Storage (storage) · permiso editar (actualizar/modificar). Úsala cuando el usuario quiera editar, actualizar, corregir o cambiar algo en storage. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/storage.md antes de actuar."
role: superadmin
module: storage
action: update
---

# mwt-superadmin-storage-editar

> Skill MCP enfocado: **Super Admin** · **Storage** · permiso **editar** (actualizar/modificar).

## Propósito
Operar el módulo **Storage** (`storage`) con la acción **editar** (actualizar/modificar) usando SOLO
...
- El alcance de este skill es **editar** sobre **Storage**; para otra operación activá el SKILL.md correspondiente.
