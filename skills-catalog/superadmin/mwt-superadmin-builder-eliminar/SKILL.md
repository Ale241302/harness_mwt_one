...
description: "Rol Super Admin · módulo MWT Builder (builder) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de builder. Herramientas MCP: builder_artefacto_eliminar. Lee el contrato en _contratos/builder.md antes de actuar."
role: superadmin
module: builder
action: delete
---

# mwt-superadmin-builder-eliminar

> Skill MCP enfocado: **Super Admin** · **MWT Builder** · permiso **eliminar** (eliminar/borrar).
