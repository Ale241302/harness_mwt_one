---
name: mwt-superadmin-pagos-leer
description: Rol Super Admin · módulo Pagos (pagos) · permiso leer (consultar/listar). Herramientas MCP: pago_applicables, pago_listar, pago_obtener. Lee el contrato en _contratos/pagos.md antes de actuar.
role: superadmin
module: pagos
action: view
---

# mwt-superadmin-pagos-leer

> Skill MCP enfocado: **Super Admin** · **Pagos** · permiso **leer** (consultar/listar).
