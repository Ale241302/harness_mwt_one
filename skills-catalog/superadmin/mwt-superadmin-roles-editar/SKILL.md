---
name: mwt-superadmin-roles-editar
description: "Rol Super Admin · módulo Roles y Permisos (roles) · permiso editar (actualizar/modificar). Úsala cuando el usuario quiera editar, actualizar, corregir o cambiar algo en roles. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/roles.md antes de actuar."
role: superadmin
module: roles
action: update
---

# mwt-superadmin-roles-editar

> Skill MCP enfocado: **Super Admin** · **Roles y Permisos** · permiso **editar** (actualizar/modificar).

## Propósito
Operar el módulo **Roles y Permisos** (`roles`) con la acción **editar** (actualizar/modificar) usando SOLO
...
- El alcance de este skill es **editar** sobre **Roles y Permisos**; para otra operación activá el SKILL.md correspondiente.
