...
description: "Rol Super Admin · módulo Cartera (cartera) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de cartera. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/cartera.md antes de actuar."
role: superadmin
module: cartera
action: delete
---

# mwt-superadmin-cartera-eliminar

> Skill MCP enfocado: **Super Admin** · **Cartera** · permiso **eliminar** (eliminar/borrar).
