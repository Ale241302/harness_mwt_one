---
name: mwt-superadmin-tickets-ver-documento
description: "Rol Super Admin · módulo Tickets (tickets) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de tickets. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/tickets.md antes de actuar."
role: superadmin
module: tickets
action: view_doc
---

# mwt-superadmin-tickets-ver-documento

> Skill MCP enfocado: **Super Admin** · **Tickets** · permiso **ver-documento** (ver/listar documentos).
