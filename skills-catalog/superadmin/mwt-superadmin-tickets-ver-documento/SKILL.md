...
description: Rol Super Admin · módulo Tickets (tickets) · permiso ver-documento (ver/listar documentos). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/tickets.md antes de actuar.
role: superadmin
module: tickets
action: view_doc
---
