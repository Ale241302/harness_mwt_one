...
description: "Rol Super Admin · módulo Motor de Tallas (sizing) · permiso editar (actualizar/modificar). Úsala cuando el usuario quiera editar, actualizar, corregir o cambiar algo en sizing. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/sizing.md antes de actuar."
role: superadmin
module: sizing
action: update
---

# mwt-superadmin-sizing-editar

> Skill MCP enfocado: **Super Admin** · **Motor de Tallas** · permiso **editar** (actualizar/modificar).
