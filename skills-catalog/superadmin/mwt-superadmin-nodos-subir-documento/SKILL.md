---
name: mwt-superadmin-nodos-subir-documento
description: "Rol Super Admin · módulo Nodos (nodos) · permiso subir-documento (subir un archivo/documento). Úsala cuando el usuario quiera subir o adjuntar un documento a nodos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/nodos.md antes de actuar."
role: superadmin
module: nodos
action: upload_doc
---

# mwt-superadmin-nodos-subir-documento

> Skill MCP enfocado: **Super Admin** · **Nodos** · permiso **subir-documento** (subir un archivo/documento).

## Propósito
Operar el módulo **Nodos** (`nodos`) con la acción **subir-documento** (subir un archivo/documento) usando SOLO
...
- Para subir el archivo de un artefacto usá `storage_subir_archivo` (`storage.create`) o `nodo_artefacto_crear` (`nodos.create`).
...
- El alcance de este skill es **subir-documento** sobre **Nodos**; para otra operación activá el SKILL.md correspondiente.
