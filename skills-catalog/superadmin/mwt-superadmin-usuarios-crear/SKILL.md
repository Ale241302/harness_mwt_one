...
# mwt-superadmin-usuarios-crear

> Skill MCP enfocado: **Super Admin** · **Usuarios** · permiso **crear** (crear).

## Propósito
Operar el módulo **Usuarios** (`usuarios`) con la acción **crear** (crear) usando SOLO
...
- El alcance de este skill es **crear** sobre **Usuarios**; para otra operación activá el SKILL.md correspondiente.
