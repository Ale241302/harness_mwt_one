---
name: mwt-viewer-pagos-ver-documento
description: "Rol Viewer (solo lectura) · módulo Pagos (pagos) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de pagos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/pagos.md antes de actuar."
role: viewer
module: pagos
action: view_doc
---

# mwt-viewer-pagos-ver-documento

> Skill MCP enfocado: **Viewer (solo lectura)** · **Pagos** · permiso **ver-documento** (ver/listar documentos).

## Propósito
Operar el módulo **Pagos** (`pagos`) con la acción **ver-documento** (ver/listar documentos) usando SOLO
...
- El alcance de este skill es **ver-documento** sobre **Pagos**; para otra operación activá el SKILL.md correspondiente.
