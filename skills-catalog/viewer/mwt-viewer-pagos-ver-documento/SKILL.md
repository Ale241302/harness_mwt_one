...
description: Rol Viewer (solo lectura) · módulo Pagos (pagos) · permiso ver-documento (ver/listar documentos). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/pagos.md antes de actuar.
role: viewer
module: pagos
action: view_doc
---
