---
name: mwt-viewer-cartera-descargar-documento
description: "Rol Viewer (solo lectura) · módulo Cartera (cartera) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de cartera. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/cartera.md antes de actuar."
role: viewer
module: cartera
action: download_doc
---

# mwt-viewer-cartera-descargar-documento

> Skill MCP enfocado: **Viewer (solo lectura)** · **Cartera** · permiso **descargar-documento** (descargar un archivo/documento).
