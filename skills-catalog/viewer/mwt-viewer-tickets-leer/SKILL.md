---
name: mwt-viewer-tickets-leer
description: Rol Viewer (solo lectura) · módulo Tickets (tickets) · permiso leer (consultar/listar). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/tickets.md antes de actuar.
role: viewer
module: tickets
action: view
---

# mwt-viewer-tickets-leer

> Skill MCP enfocado: **Viewer (solo lectura)** · **Tickets** · permiso **leer** (consultar/listar).

## Propósito
Operar el módulo **Tickets** (`tickets`) con la acción **leer** (consultar/listar) usando SOLO
...
- El alcance de este skill es **leer** sobre **Tickets**; para otra operación activá el SKILL.md correspondiente.
