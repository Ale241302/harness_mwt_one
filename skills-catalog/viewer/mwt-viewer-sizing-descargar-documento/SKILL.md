---
name: mwt-viewer-sizing-descargar-documento
description: "Rol Viewer (solo lectura) · módulo Motor de Tallas (sizing) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de sizing. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/sizing.md antes de actuar."
role: viewer
module: sizing
action: download_doc
---

# mwt-viewer-sizing-descargar-documento

> Skill MCP enfocado: **Viewer (solo lectura)** · **Motor de Tallas** · permiso **descargar-documento** (descargar un archivo/documento).
