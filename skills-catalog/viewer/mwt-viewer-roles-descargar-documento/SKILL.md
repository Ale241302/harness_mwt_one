...
description: "Rol Viewer (solo lectura) · módulo Roles y Permisos (roles) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de roles. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/roles.md antes de actuar."
role: viewer
module: roles
action: download_doc
---

# mwt-viewer-roles-descargar-documento

> Skill MCP enfocado: **Viewer (solo lectura)** · **Roles y Permisos** · permiso **descargar-documento** (descargar un archivo/documento).
