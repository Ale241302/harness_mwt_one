...
description: "Rol Viewer (solo lectura) · módulo Usuarios (usuarios) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de usuarios. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/usuarios.md antes de actuar."
role: viewer
module: usuarios
action: download_doc
---

# mwt-viewer-usuarios-descargar-documento

> Skill MCP enfocado: **Viewer (solo lectura)** · **Usuarios** · permiso **descargar-documento** (descargar un archivo/documento).
