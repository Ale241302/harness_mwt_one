---
name: mwt-viewer-cartera-ver-documento
description: "Rol Viewer (solo lectura) · módulo Cartera (cartera) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de cartera. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/cartera.md antes de actuar."
role: viewer
module: cartera
action: view_doc
---

# mwt-viewer-cartera-ver-documento

> Skill MCP enfocado: **Viewer (solo lectura)** · **Cartera** · permiso **ver-documento** (ver/listar documentos).

## Propósito
Operar el módulo **Cartera** (`cartera`) con la acción **ver-documento** (ver/listar documentos) usando SOLO
...
- El alcance de este skill es **ver-documento** sobre **Cartera**; para otra operación activá el SKILL.md correspondiente.
