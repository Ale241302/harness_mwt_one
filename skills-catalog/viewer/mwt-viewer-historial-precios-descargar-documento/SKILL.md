---
name: mwt-viewer-historial-precios-descargar-documento
description: Rol Viewer (solo lectura) · módulo Historial de precios (historial-precios) · permiso descargar-documento (descargar un archivo/documento). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/historial-precios.md antes de actuar.
role: viewer
module: historial-precios
action: download_doc
---

# mwt-viewer-historial-precios-descargar-documento

> Skill MCP enfocado: **Viewer (solo lectura)** · **Historial de precios** · permiso **descargar-documento** (descargar un archivo/documento).
