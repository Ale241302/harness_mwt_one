---
name: mwt-viewer-usuarios-ver-documento
description: "Rol Viewer (solo lectura) · módulo Usuarios (usuarios) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de usuarios. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/usuarios.md antes de actuar."
role: viewer
module: usuarios
action: view_doc
---

# mwt-viewer-usuarios-ver-documento

> Skill MCP enfocado: **Viewer (solo lectura)** · **Usuarios** · permiso **ver-documento** (ver/listar documentos).

## Propósito
Operar el módulo **Usuarios** (`usuarios`) con la acción **ver-documento** (ver/listar documentos) usando SOLO
...
- El alcance de este skill es **ver-documento** sobre **Usuarios**; para otra operación activá el SKILL.md correspondiente.
