---
name: mwt-viewer-notificaciones-descargar-documento
description: Rol Viewer (solo lectura) · módulo Notificaciones (notificaciones) · permiso descargar-documento (descargar un archivo/documento). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/notificaciones.md antes de actuar.
role: viewer
module: notificaciones
action: download_doc
---

# mwt-viewer-notificaciones-descargar-documento

> Skill MCP enfocado: **Viewer (solo lectura)** · **Notificaciones** · permiso **descargar-documento** (descargar un archivo/documento).

## Propósito
Operar el módulo **Notificaciones** (`notificaciones`) con la acción **descargar-documento** (descargar un archivo/documento) usando SOLO
...
- El alcance de este skill es **descargar-documento** sobre **Notificaciones**; para otra operación activá el SKILL.md correspondiente.
