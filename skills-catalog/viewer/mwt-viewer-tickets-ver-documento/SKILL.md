---
name: mwt-viewer-tickets-ver-documento
description: "Rol Viewer (solo lectura) · módulo Tickets (tickets) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de tickets. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/tickets.md antes de actuar."
role: viewer
module: tickets
action: view_doc
---

# mwt-viewer-tickets-ver-documento

> Skill MCP enfocado: **Viewer (solo lectura)** · **Tickets** · permiso **ver-documento** (ver/listar documentos).

## Propósito
Operar el módulo **Tickets** (`tickets`) con la acción **ver-documento** (ver/listar documentos) usando SOLO
...
- El alcance de este skill es **ver-documento** sobre **Tickets**; para otra operación activá el SKILL.md correspondiente.
