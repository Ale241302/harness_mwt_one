---
name: mwt-viewer-nodos-descargar-documento
description: "Rol Viewer (solo lectura) · módulo Nodos (nodos) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de nodos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/nodos.md antes de actuar."
role: viewer
module: nodos
action: download_doc
---

# mwt-viewer-nodos-descargar-documento

> Skill MCP enfocado: **Viewer (solo lectura)** · **Nodos** · permiso **descargar-documento** (descargar un archivo/documento).

## Propósito
Operar el módulo **Nodos** (`nodos`) con la acción **descargar-documento** (descargar un archivo/documento) usando SOLO
...
- El binario de un artefacto se descarga con `artefacto_archivo_descargar` (permiso `storage.download_doc`).
...
- El alcance de este skill es **descargar-documento** sobre **Nodos**; para otra operación activá el SKILL.md correspondiente.
