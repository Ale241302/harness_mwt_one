...
description: "Rol Viewer (solo lectura) · módulo Expedientes (expedientes) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de expedientes. Herramientas MCP: documento_descargar. Lee el contrato en _contratos/expedientes.md antes de actuar."
role: viewer
module: expedientes
action: download_doc
---

# mwt-viewer-expedientes-descargar-documento

> Skill MCP enfocado: **Viewer (solo lectura)** · **Expedientes** · permiso **descargar-documento** (descargar un archivo/documento).
