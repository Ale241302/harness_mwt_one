...
description: Rol Viewer (solo lectura) · módulo Inventario (inventario) · permiso descargar-documento (descargar un archivo/documento). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/inventario.md antes de actuar.
role: viewer
module: inventario
action: download_doc
---
