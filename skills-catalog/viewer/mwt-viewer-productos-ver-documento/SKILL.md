---
name: mwt-viewer-productos-ver-documento
description: "Rol Viewer (solo lectura) · módulo Productos (productos) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de productos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/productos.md antes de actuar."
role: viewer
module: productos
action: view_doc
---

# mwt-viewer-productos-ver-documento

> Skill MCP enfocado: **Viewer (solo lectura)** · **Productos** · permiso **ver-documento** (ver/listar documentos).

## Propósito
Operar el módulo **Productos** (`productos`) con la acción **ver-documento** (ver/listar documentos) usando SOLO
...
- El alcance de este skill es **ver-documento** sobre **Productos**; para otra operación activá el SKILL.md correspondiente.
