---
name: mwt-viewer-cartera-leer
description: Rol Viewer (solo lectura) · módulo Cartera (cartera) · permiso leer (consultar/listar). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/cartera.md antes de actuar.
role: viewer
module: cartera
action: view
---

# mwt-viewer-cartera-leer

> Skill MCP enfocado: **Viewer (solo lectura)** · **Cartera** · permiso **leer** (consultar/listar).

## Propósito
Operar el módulo **Cartera** (`cartera`) con la acción **leer** (consultar/listar) usando SOLO
...
- El alcance de este skill es **leer** sobre **Cartera**; para otra operación activá el SKILL.md correspondiente.
