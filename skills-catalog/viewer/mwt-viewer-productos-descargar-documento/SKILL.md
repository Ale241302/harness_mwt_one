...
description: "Rol Viewer (solo lectura) · módulo Productos (productos) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de productos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/productos.md antes de actuar."
role: viewer
module: productos
action: download_doc
---

# mwt-viewer-productos-descargar-documento

> Skill MCP enfocado: **Viewer (solo lectura)** · **Productos** · permiso **descargar-documento** (descargar un archivo/documento).
