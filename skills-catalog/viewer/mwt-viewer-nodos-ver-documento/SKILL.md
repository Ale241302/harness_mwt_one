...
description: "Rol Viewer (solo lectura) · módulo Nodos (nodos) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de nodos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/nodos.md antes de actuar."
role: viewer
module: nodos
action: view_doc
---

# mwt-viewer-nodos-ver-documento

> Skill MCP enfocado: **Viewer (solo lectura)** · **Nodos** · permiso **ver-documento** (ver/listar documentos).
