---
name: mwt-viewer-inventario-ver-documento
description: "Rol Viewer (solo lectura) · módulo Inventario (inventario) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de inventario. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/inventario.md antes de actuar."
role: viewer
module: inventario
action: view_doc
---

# mwt-viewer-inventario-ver-documento

> Skill MCP enfocado: **Viewer (solo lectura)** · **Inventario** · permiso **ver-documento** (ver/listar documentos).

## Propósito
Operar el módulo **Inventario** (`inventario`) con la acción **ver-documento** (ver/listar documentos) usando SOLO
...
- El alcance de este skill es **ver-documento** sobre **Inventario**; para otra operación activá el SKILL.md correspondiente.
