...
description: Rol Viewer (solo lectura) · módulo Storage (storage) · permiso descargar-documento (descargar un archivo/documento). Herramientas MCP: artefacto_archivo_descargar. Lee el contrato en _contratos/storage.md antes de actuar.
role: viewer
module: storage
action: download_doc
---
