---
name: mwt-client_b2b-portal-leer
description: Rol Cliente B2B · módulo Portal (portal) · permiso leer (consultar/listar). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/portal.md antes de actuar.
role: client_b2b
module: portal
action: view
---

# mwt-client_b2b-portal-leer

> Skill MCP enfocado: **Cliente B2B** · **Portal** · permiso **leer** (consultar/listar).

## Propósito
Operar el módulo **Portal** (`portal`) con la acción **leer** (consultar/listar) usando SOLO
...
- El alcance de este skill es **leer** sobre **Portal**; para otra operación activá el SKILL.md correspondiente.
