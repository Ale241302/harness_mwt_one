---
name: mwt-client_b2b-productos-leer
description: Rol Cliente B2B · módulo Productos (productos) · permiso leer (consultar/listar). Herramientas MCP: producto_listar, producto_obtener, producto_buscar, producto_precio_cliente, producto_ficha_tecnica, ncm_listar. Lee el contrato en _contratos/productos.md antes de actuar.
role: client_b2b
module: productos
action: view
---

# mwt-client_b2b-productos-leer

> Skill MCP enfocado: **Cliente B2B** · **Productos** · permiso **leer** (consultar/listar).
