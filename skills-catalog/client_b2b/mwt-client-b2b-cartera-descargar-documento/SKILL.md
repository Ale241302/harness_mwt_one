---
name: mwt-client-b2b-cartera-descargar-documento
description: "Rol Cliente B2B · módulo Cartera (cartera) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de cartera. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/cartera.md antes de actuar."
role: client_b2b
module: cartera
action: download_doc
---

# mwt-client_b2b-cartera-descargar-documento

> Skill MCP enfocado: **Cliente B2B** · **Cartera** · permiso **descargar-documento** (descargar un archivo/documento).

## Propósito
Operar el módulo **Cartera** (`cartera`) con la acción **descargar-documento** (descargar un archivo/documento) usando SOLO
...
- El alcance de este skill es **descargar-documento** sobre **Cartera**; para otra operación activá el SKILL.md correspondiente.
- Contrato completo: `_contratos/cartera.md`.
