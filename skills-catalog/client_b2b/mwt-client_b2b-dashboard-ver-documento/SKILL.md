---
name: mwt-client_b2b-dashboard-ver-documento
...
# mwt-client_b2b-dashboard-ver-documento

> Skill MCP enfocado: **Cliente B2B** · **Dashboard** · permiso **ver-documento** (ver/listar documentos).
