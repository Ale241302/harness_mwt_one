---
name: mwt-client_b2b-storage-leer
description: Rol Cliente B2B · módulo Storage (storage) · permiso leer (consultar/listar). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/storage.md antes de actuar.
role: client_b2b
module: storage
action: view
---

# mwt-client_b2b-storage-leer

> Skill MCP enfocado: **Cliente B2B** · **Storage** · permiso **leer** (consultar/listar).
