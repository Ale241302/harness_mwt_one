---
name: mwt-client-b2b-storage-ver-documento
description: "Rol Cliente B2B · módulo Storage (storage) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de storage. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/storage.md antes de actuar."
role: client_b2b
module: storage
action: view_doc
---

# mwt-client_b2b-storage-ver-documento

> Skill MCP enfocado: **Cliente B2B** · **Storage** · permiso **ver-documento** (ver/listar documentos).
