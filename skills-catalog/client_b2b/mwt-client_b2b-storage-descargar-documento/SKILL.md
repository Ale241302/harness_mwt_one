---
name: mwt-client_b2b-storage-descargar-documento
...
# mwt-client_b2b-storage-descargar-documento

> Skill MCP enfocado: **Cliente B2B** · **Storage** · permiso **descargar-documento** (descargar un archivo/documento).
