...
description: "Rol Compras · módulo Cartera (cartera) · permiso leer (consultar/listar). Úsala cuando el usuario quiera consultar, listar, ver, buscar o revisar cartera (por ejemplo 'muéstrame cartera' o 'busca en cartera'). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/cartera.md antes de actuar."
role: compras
module: cartera
action: view
---

# mwt-compras-cartera-leer

> Skill MCP enfocado: **Compras** · **Cartera** · permiso **leer** (consultar/listar).
