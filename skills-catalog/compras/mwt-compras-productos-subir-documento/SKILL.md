---
name: mwt-compras-productos-subir-documento
description: "Rol Compras · módulo Productos (productos) · permiso subir-documento (subir un archivo/documento). Úsala cuando el usuario quiera subir o adjuntar un documento a productos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/productos.md antes de actuar."
role: compras
module: productos
action: upload_doc
---

# mwt-compras-productos-subir-documento

> Skill MCP enfocado: **Compras** · **Productos** · permiso **subir-documento** (subir un archivo/documento).

## Propósito
Operar el módulo **Productos** (`productos`) con la acción **subir-documento** (subir un archivo/documento) usando SOLO
...
- El alcance de este skill es **subir-documento** sobre **Productos**; para otra operación activá el SKILL.md correspondiente.
