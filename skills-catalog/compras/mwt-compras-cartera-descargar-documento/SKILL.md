---
name: mwt-compras-cartera-descargar-documento
description: "Rol Compras · módulo Cartera (cartera) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de cartera. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/cartera.md antes de actuar."
role: compras
module: cartera
action: download_doc
---

# mwt-compras-cartera-descargar-documento

> Skill MCP enfocado: **Compras** · **Cartera** · permiso **descargar-documento** (descargar un archivo/documento).
