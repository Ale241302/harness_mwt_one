---
name: mwt-compras-historial-precios-descargar-documento
description: Rol Compras · módulo Historial de precios (historial-precios) · permiso descargar-documento (descargar un archivo/documento). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/historial-precios.md antes de actuar.
role: compras
module: historial-precios
action: download_doc
---

# mwt-compras-historial-precios-descargar-documento

> Skill MCP enfocado: **Compras** · **Historial de precios** · permiso **descargar-documento** (descargar un archivo/documento).
