...
description: Rol Compras · módulo Roles y Permisos (roles) · permiso descargar-documento (descargar un archivo/documento). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/roles.md antes de actuar.
role: compras
module: roles
action: download_doc
---
