---
name: mwt-compras-roles-ver-documento
description: "Rol Compras · módulo Roles y Permisos (roles) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de roles. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/roles.md antes de actuar."
role: compras
module: roles
action: view_doc
---

# mwt-compras-roles-ver-documento

> Skill MCP enfocado: **Compras** · **Roles y Permisos** · permiso **ver-documento** (ver/listar documentos).
