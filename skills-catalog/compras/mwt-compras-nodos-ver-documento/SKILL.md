...
description: "Rol Compras · módulo Nodos (nodos) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de nodos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/nodos.md antes de actuar."
role: compras
module: nodos
action: view_doc
---

# mwt-compras-nodos-ver-documento

> Skill MCP enfocado: **Compras** · **Nodos** · permiso **ver-documento** (ver/listar documentos).
