...
description: Rol Compras · módulo Expedientes (expedientes) · permiso ver-documento (ver/listar documentos). Herramientas MCP: documento_listar. Lee el contrato en _contratos/expedientes.md antes de actuar.
role: compras
module: expedientes
action: view_doc
---
