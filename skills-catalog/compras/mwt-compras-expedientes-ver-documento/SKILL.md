---
name: mwt-compras-expedientes-ver-documento
description: "Rol Compras · módulo Expedientes (expedientes) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de expedientes. Herramientas MCP: documento_listar. Lee el contrato en _contratos/expedientes.md antes de actuar."
role: compras
module: expedientes
action: view_doc
---

# mwt-compras-expedientes-ver-documento

> Skill MCP enfocado: **Compras** · **Expedientes** · permiso **ver-documento** (ver/listar documentos).
