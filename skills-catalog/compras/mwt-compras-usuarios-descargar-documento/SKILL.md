---
name: mwt-compras-usuarios-descargar-documento
description: "Rol Compras · módulo Usuarios (usuarios) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de usuarios. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/usuarios.md antes de actuar."
role: compras
module: usuarios
action: download_doc
---

# mwt-compras-usuarios-descargar-documento

> Skill MCP enfocado: **Compras** · **Usuarios** · permiso **descargar-documento** (descargar un archivo/documento).
