...
description: "Rol Compras · módulo Clientes (clientes) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en clientes. Herramientas MCP: cliente_crear. Lee el contrato en _contratos/clientes.md antes de actuar."
role: compras
module: clientes
action: create
---

# mwt-compras-clientes-crear

> Skill MCP enfocado: **Compras** · **Clientes** · permiso **crear** (crear).

## Propósito
Operar el módulo **Clientes** (`clientes`) con la acción **crear** (crear) usando SOLO
...
## Herramientas MCP para esta acción
  - `cliente_crear` — codigo_marluvas (10 dígitos), cedula_juridica, tipo (B2B/CONSUMIDOR/DISTRIBUIDOR),

## Firmas (cómo invocar)
  - `cliente_crear` → `def cliente_crear(datos: dict) -> Any:`
...
- El alcance de este skill es **crear** sobre **Clientes**; para otra operación activá el SKILL.md correspondiente.
