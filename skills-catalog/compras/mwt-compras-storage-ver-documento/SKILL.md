---
name: mwt-compras-storage-ver-documento
description: "Rol Compras · módulo Storage (storage) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de storage. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/storage.md antes de actuar."
role: compras
module: storage
action: view_doc
---

# mwt-compras-storage-ver-documento

> Skill MCP enfocado: **Compras** · **Storage** · permiso **ver-documento** (ver/listar documentos).
