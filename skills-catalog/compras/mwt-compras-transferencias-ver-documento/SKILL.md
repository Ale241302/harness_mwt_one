---
name: mwt-compras-transferencias-ver-documento
description: "Rol Compras · módulo Transferencias (transferencias) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de transferencias. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/transferencias.md antes de actuar."
role: compras
module: transferencias
action: view_doc
---

# mwt-compras-transferencias-ver-documento

> Skill MCP enfocado: **Compras** · **Transferencias** · permiso **ver-documento** (ver/listar documentos).
