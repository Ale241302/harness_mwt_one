---
name: mwt-compras-pagos-ver-documento
description: "Rol Compras · módulo Pagos (pagos) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de pagos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/pagos.md antes de actuar."
role: compras
module: pagos
action: view_doc
---

# mwt-compras-pagos-ver-documento

> Skill MCP enfocado: **Compras** · **Pagos** · permiso **ver-documento** (ver/listar documentos).
