---
name: mwt-compras-nodos-leer
description: Rol Compras · módulo Nodos (nodos) · permiso leer (consultar/listar). Herramientas MCP: nodo_listar, nodo_obtener, nodo_artefactos_listar, builder_templates_listar, builder_template_obtener. Lee el contrato en _contratos/nodos.md antes de actuar.
role: compras
module: nodos
action: view
---

# mwt-compras-nodos-leer

> Skill MCP enfocado: **Compras** · **Nodos** · permiso **leer** (consultar/listar).
