---
name: mwt-compras-marcas-subir-documento
description: "Rol Compras · módulo Marcas (marcas) · permiso subir-documento (subir un archivo/documento). Úsala cuando el usuario quiera subir o adjuntar un documento a marcas. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/marcas.md antes de actuar."
role: compras
module: marcas
action: upload_doc
---

# mwt-compras-marcas-subir-documento

> Skill MCP enfocado: **Compras** · **Marcas** · permiso **subir-documento** (subir un archivo/documento).
