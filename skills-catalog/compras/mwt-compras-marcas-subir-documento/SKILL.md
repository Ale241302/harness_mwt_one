...
description: Rol Compras · módulo Marcas (marcas) · permiso subir-documento (subir un archivo/documento). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/marcas.md antes de actuar.
role: compras
module: marcas
action: upload_doc
---
