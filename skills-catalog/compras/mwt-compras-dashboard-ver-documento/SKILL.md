---
name: mwt-compras-dashboard-ver-documento
description: "Rol Compras · módulo Dashboard (dashboard) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de dashboard. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/dashboard.md antes de actuar."
role: compras
module: dashboard
action: view_doc
---

# mwt-compras-dashboard-ver-documento

> Skill MCP enfocado: **Compras** · **Dashboard** · permiso **ver-documento** (ver/listar documentos).
