---
name: mwt-compras-marcas-editar
description: "Rol Compras · módulo Marcas (marcas) · permiso editar (actualizar/modificar). Úsala cuando el usuario quiera editar, actualizar, corregir o cambiar algo en marcas. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/marcas.md antes de actuar."
role: compras
module: marcas
action: update
---

# mwt-compras-marcas-editar

> Skill MCP enfocado: **Compras** · **Marcas** · permiso **editar** (actualizar/modificar).
