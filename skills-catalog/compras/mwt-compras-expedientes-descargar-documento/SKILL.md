...
description: "Rol Compras · módulo Expedientes (expedientes) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de expedientes. Herramientas MCP: documento_descargar. Lee el contrato en _contratos/expedientes.md antes de actuar."
role: compras
module: expedientes
action: download_doc
---

# mwt-compras-expedientes-descargar-documento

> Skill MCP enfocado: **Compras** · **Expedientes** · permiso **descargar-documento** (descargar un archivo/documento).
