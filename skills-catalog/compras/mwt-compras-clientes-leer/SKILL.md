...
description: "Rol Compras · módulo Clientes (clientes) · permiso leer (consultar/listar). Úsala cuando el usuario quiera consultar, listar, ver, buscar o revisar clientes (por ejemplo 'muéstrame clientes' o 'busca en clientes'). Herramientas MCP: cliente_listar, cliente_obtener, cliente_subsidiarias, cliente_kpis_pool. Lee el contrato en _contratos/clientes.md antes de actuar."
role: compras
module: clientes
action: view
---

# mwt-compras-clientes-leer

> Skill MCP enfocado: **Compras** · **Clientes** · permiso **leer** (consultar/listar).
