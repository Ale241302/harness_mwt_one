---
name: mwt-compras-dashboard-descargar-documento
description: "Rol Compras · módulo Dashboard (dashboard) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de dashboard. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/dashboard.md antes de actuar."
role: compras
module: dashboard
action: download_doc
---

# mwt-compras-dashboard-descargar-documento

> Skill MCP enfocado: **Compras** · **Dashboard** · permiso **descargar-documento** (descargar un archivo/documento).
