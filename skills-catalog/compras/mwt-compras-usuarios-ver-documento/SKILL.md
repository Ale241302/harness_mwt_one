...
description: "Rol Compras · módulo Usuarios (usuarios) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de usuarios. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/usuarios.md antes de actuar."
role: compras
module: usuarios
action: view_doc
---

# mwt-compras-usuarios-ver-documento

> Skill MCP enfocado: **Compras** · **Usuarios** · permiso **ver-documento** (ver/listar documentos).
