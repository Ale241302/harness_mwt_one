---
name: mwt-manager-roles-eliminar
description: "Rol Manager · módulo Roles y Permisos (roles) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de roles. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/roles.md antes de actuar."
role: manager
module: roles
action: delete
---

# mwt-manager-roles-eliminar

> Skill MCP enfocado: **Manager** · **Roles y Permisos** · permiso **eliminar** (eliminar/borrar).

## Propósito
Operar el módulo **Roles y Permisos** (`roles`) con la acción **eliminar** (eliminar/borrar) usando SOLO
...
- El alcance de este skill es **eliminar** sobre **Roles y Permisos**; para otra operación activá el SKILL.md correspondiente.
