...
description: Rol Manager · módulo Roles y Permisos (roles) · permiso eliminar (eliminar/borrar). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/roles.md antes de actuar.
role: manager
module: roles
action: delete
---
