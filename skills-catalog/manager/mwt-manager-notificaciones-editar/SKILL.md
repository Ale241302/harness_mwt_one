---
name: mwt-manager-notificaciones-editar
description: Rol Manager · módulo Notificaciones (notificaciones) · permiso editar (actualizar/modificar). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/notificaciones.md antes de actuar.
role: manager
module: notificaciones
action: update
---

# mwt-manager-notificaciones-editar

> Skill MCP enfocado: **Manager** · **Notificaciones** · permiso **editar** (actualizar/modificar).
