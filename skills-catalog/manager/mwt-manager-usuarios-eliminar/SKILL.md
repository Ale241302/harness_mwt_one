---
name: mwt-manager-usuarios-eliminar
description: "Rol Manager · módulo Usuarios (usuarios) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de usuarios. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/usuarios.md antes de actuar."
role: manager
module: usuarios
action: delete
---

# mwt-manager-usuarios-eliminar

> Skill MCP enfocado: **Manager** · **Usuarios** · permiso **eliminar** (eliminar/borrar).
