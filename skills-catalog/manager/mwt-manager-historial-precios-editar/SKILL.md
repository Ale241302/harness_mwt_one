---
name: mwt-manager-historial-precios-editar
description: Rol Manager · módulo Historial de precios (historial-precios) · permiso editar (actualizar/modificar). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/historial-precios.md antes de actuar.
role: manager
module: historial-precios
action: update
---

# mwt-manager-historial-precios-editar

> Skill MCP enfocado: **Manager** · **Historial de precios** · permiso **editar** (actualizar/modificar).
