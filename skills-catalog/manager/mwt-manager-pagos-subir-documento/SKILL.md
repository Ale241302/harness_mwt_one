...
description: "Rol Manager · módulo Pagos (pagos) · permiso subir-documento (subir un archivo/documento). Úsala cuando el usuario quiera subir o adjuntar un documento a pagos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/pagos.md antes de actuar."
role: manager
module: pagos
action: upload_doc
---

# mwt-manager-pagos-subir-documento

> Skill MCP enfocado: **Manager** · **Pagos** · permiso **subir-documento** (subir un archivo/documento).
