---
name: mwt-manager-tickets-editar
description: "Rol Manager · módulo Tickets (tickets) · permiso editar (actualizar/modificar). Úsala cuando el usuario quiera editar, actualizar, corregir o cambiar algo en tickets. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/tickets.md antes de actuar."
role: manager
module: tickets
action: update
---

# mwt-manager-tickets-editar

> Skill MCP enfocado: **Manager** · **Tickets** · permiso **editar** (actualizar/modificar).

## Propósito
Operar el módulo **Tickets** (`tickets`) con la acción **editar** (actualizar/modificar) usando SOLO
...
- El alcance de este skill es **editar** sobre **Tickets**; para otra operación activá el SKILL.md correspondiente.
