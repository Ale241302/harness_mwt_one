...
description: Rol Manager · módulo Historial de precios (historial-precios) · permiso crear (crear). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/historial-precios.md antes de actuar.
role: manager
