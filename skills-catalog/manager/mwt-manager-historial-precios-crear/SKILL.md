---
name: mwt-manager-historial-precios-crear
description: "Rol Manager · módulo Historial de precios (historial-precios) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en historial-precios. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/historial-precios.md antes de actuar."
role: manager
module: historial-precios
action: create
---

# mwt-manager-historial-precios-crear

> Skill MCP enfocado: **Manager** · **Historial de precios** · permiso **crear** (crear).
