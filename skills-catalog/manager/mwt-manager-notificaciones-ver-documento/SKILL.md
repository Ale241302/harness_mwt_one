---
name: mwt-manager-notificaciones-ver-documento
description: "Rol Manager · módulo Notificaciones (notificaciones) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de notificaciones. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/notificaciones.md antes de actuar."
role: manager
module: notificaciones
action: view_doc
---

# mwt-manager-notificaciones-ver-documento

> Skill MCP enfocado: **Manager** · **Notificaciones** · permiso **ver-documento** (ver/listar documentos).
