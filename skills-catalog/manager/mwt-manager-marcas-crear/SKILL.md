---
name: mwt-manager-marcas-crear
description: "Rol Manager · módulo Marcas (marcas) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en marcas. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/marcas.md antes de actuar."
role: manager
module: marcas
action: create
---

# mwt-manager-marcas-crear

> Skill MCP enfocado: **Manager** · **Marcas** · permiso **crear** (crear).
