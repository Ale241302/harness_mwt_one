...
description: Rol Manager · módulo Productos (productos) · permiso crear (crear). Herramientas MCP: producto_crear, producto_alias_crear. Lee el contrato en _contratos/productos.md antes de actuar.
role: manager
module: productos
action: create
---
