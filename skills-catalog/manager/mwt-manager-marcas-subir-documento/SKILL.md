...
description: "Rol Manager · módulo Marcas (marcas) · permiso subir-documento (subir un archivo/documento). Úsala cuando el usuario quiera subir o adjuntar un documento a marcas. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/marcas.md antes de actuar."
role: manager
module: marcas
action: upload_doc
---

# mwt-manager-marcas-subir-documento

> Skill MCP enfocado: **Manager** · **Marcas** · permiso **subir-documento** (subir un archivo/documento).
