---
name: mwt-manager-portal-editar
description: "Rol Manager · módulo Portal (portal) · permiso editar (actualizar/modificar). Úsala cuando el usuario quiera editar, actualizar, corregir o cambiar algo en portal. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/portal.md antes de actuar."
role: manager
module: portal
action: update
---

# mwt-manager-portal-editar

> Skill MCP enfocado: **Manager** · **Portal** · permiso **editar** (actualizar/modificar).

## Propósito
Operar el módulo **Portal** (`portal`) con la acción **editar** (actualizar/modificar) usando SOLO
...
- El alcance de este skill es **editar** sobre **Portal**; para otra operación activá el SKILL.md correspondiente.
