---
name: mwt-manager-clientes-eliminar
description: "Rol Manager · módulo Clientes (clientes) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de clientes. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/clientes.md antes de actuar."
role: manager
module: clientes
action: delete
---

# mwt-manager-clientes-eliminar

> Skill MCP enfocado: **Manager** · **Clientes** · permiso **eliminar** (eliminar/borrar).
