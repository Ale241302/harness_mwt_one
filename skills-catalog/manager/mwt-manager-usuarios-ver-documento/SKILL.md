---
name: mwt-manager-usuarios-ver-documento
description: "Rol Manager · módulo Usuarios (usuarios) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de usuarios. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/usuarios.md antes de actuar."
role: manager
module: usuarios
action: view_doc
---

# mwt-manager-usuarios-ver-documento

> Skill MCP enfocado: **Manager** · **Usuarios** · permiso **ver-documento** (ver/listar documentos).
