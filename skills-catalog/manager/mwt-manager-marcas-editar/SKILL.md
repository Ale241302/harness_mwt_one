---
name: mwt-manager-marcas-editar
description: "Rol Manager · módulo Marcas (marcas) · permiso editar (actualizar/modificar). Úsala cuando el usuario quiera editar, actualizar, corregir o cambiar algo en marcas. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/marcas.md antes de actuar."
role: manager
module: marcas
action: update
---

# mwt-manager-marcas-editar

> Skill MCP enfocado: **Manager** · **Marcas** · permiso **editar** (actualizar/modificar).
