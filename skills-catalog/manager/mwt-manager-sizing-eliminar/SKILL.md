---
name: mwt-manager-sizing-eliminar
description: "Rol Manager · módulo Motor de Tallas (sizing) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de sizing. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/sizing.md antes de actuar."
role: manager
module: sizing
action: delete
---

# mwt-manager-sizing-eliminar

> Skill MCP enfocado: **Manager** · **Motor de Tallas** · permiso **eliminar** (eliminar/borrar).

## Propósito
Operar el módulo **Motor de Tallas** (`sizing`) con la acción **eliminar** (eliminar/borrar) usando SOLO
...
- El alcance de este skill es **eliminar** sobre **Motor de Tallas**; para otra operación activá el SKILL.md correspondiente.
