---
name: mwt-manager-cartera-editar
description: "Rol Manager · módulo Cartera (cartera) · permiso editar (actualizar/modificar). Úsala cuando el usuario quiera editar, actualizar, corregir o cambiar algo en cartera. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/cartera.md antes de actuar."
role: manager
module: cartera
action: update
---

# mwt-manager-cartera-editar

> Skill MCP enfocado: **Manager** · **Cartera** · permiso **editar** (actualizar/modificar).

## Propósito
Operar el módulo **Cartera** (`cartera`) con la acción **editar** (actualizar/modificar) usando SOLO
...
- El alcance de este skill es **editar** sobre **Cartera**; para otra operación activá el SKILL.md correspondiente.
