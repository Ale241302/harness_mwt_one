---
name: mwt-manager-portal-subir-documento
description: "Rol Manager · módulo Portal (portal) · permiso subir-documento (subir un archivo/documento). Úsala cuando el usuario quiera subir o adjuntar un documento a portal. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/portal.md antes de actuar."
role: manager
module: portal
action: upload_doc
---

# mwt-manager-portal-subir-documento

> Skill MCP enfocado: **Manager** · **Portal** · permiso **subir-documento** (subir un archivo/documento).

## Propósito
Operar el módulo **Portal** (`portal`) con la acción **subir-documento** (subir un archivo/documento) usando SOLO
...
- El alcance de este skill es **subir-documento** sobre **Portal**; para otra operación activá el SKILL.md correspondiente.
