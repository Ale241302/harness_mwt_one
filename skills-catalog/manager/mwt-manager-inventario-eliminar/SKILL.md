---
name: mwt-manager-inventario-eliminar
description: "Rol Manager · módulo Inventario (inventario) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de inventario. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/inventario.md antes de actuar."
role: manager
module: inventario
action: delete
---

# mwt-manager-inventario-eliminar

> Skill MCP enfocado: **Manager** · **Inventario** · permiso **eliminar** (eliminar/borrar).

## Propósito
Operar el módulo **Inventario** (`inventario`) con la acción **eliminar** (eliminar/borrar) usando SOLO
...
- El alcance de este skill es **eliminar** sobre **Inventario**; para otra operación activá el SKILL.md correspondiente.
