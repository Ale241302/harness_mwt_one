...
description: "Rol Manager · módulo Productos (productos) · permiso subir-documento (subir un archivo/documento). Úsala cuando el usuario quiera subir o adjuntar un documento a productos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/productos.md antes de actuar."
role: manager
module: productos
action: upload_doc
---

# mwt-manager-productos-subir-documento

> Skill MCP enfocado: **Manager** · **Productos** · permiso **subir-documento** (subir un archivo/documento).
