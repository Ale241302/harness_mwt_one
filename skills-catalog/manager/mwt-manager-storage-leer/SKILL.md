---
name: mwt-manager-storage-leer
description: Rol Manager · módulo Storage (storage) · permiso leer (consultar/listar). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/storage.md antes de actuar.
role: manager
module: storage
action: view
---

# mwt-manager-storage-leer

> Skill MCP enfocado: **Manager** · **Storage** · permiso **leer** (consultar/listar).
