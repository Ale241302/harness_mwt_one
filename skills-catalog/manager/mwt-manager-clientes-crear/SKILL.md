...
description: "Rol Manager · módulo Clientes (clientes) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en clientes. Herramientas MCP: cliente_crear. Lee el contrato en _contratos/clientes.md antes de actuar."
role: manager
module: clientes
action: create
---

# mwt-manager-clientes-crear

> Skill MCP enfocado: **Manager** · **Clientes** · permiso **crear** (crear).
