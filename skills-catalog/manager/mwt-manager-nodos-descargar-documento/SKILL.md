---
name: mwt-manager-nodos-descargar-documento
description: "Rol Manager · módulo Nodos (nodos) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de nodos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/nodos.md antes de actuar."
role: manager
module: nodos
action: download_doc
---

# mwt-manager-nodos-descargar-documento

> Skill MCP enfocado: **Manager** · **Nodos** · permiso **descargar-documento** (descargar un archivo/documento).
