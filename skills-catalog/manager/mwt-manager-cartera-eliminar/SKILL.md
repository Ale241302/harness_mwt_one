---
name: mwt-manager-cartera-eliminar
description: "Rol Manager · módulo Cartera (cartera) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de cartera. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/cartera.md antes de actuar."
role: manager
module: cartera
action: delete
---

# mwt-manager-cartera-eliminar

> Skill MCP enfocado: **Manager** · **Cartera** · permiso **eliminar** (eliminar/borrar).
