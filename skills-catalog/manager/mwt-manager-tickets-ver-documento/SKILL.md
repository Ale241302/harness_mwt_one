...
description: "Rol Manager · módulo Tickets (tickets) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de tickets. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/tickets.md antes de actuar."
role: manager
module: tickets
action: view_doc
---

# mwt-manager-tickets-ver-documento

> Skill MCP enfocado: **Manager** · **Tickets** · permiso **ver-documento** (ver/listar documentos).
