---
name: mwt-manager-dashboard-ver-documento
description: "Rol Manager · módulo Dashboard (dashboard) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de dashboard. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/dashboard.md antes de actuar."
role: manager
module: dashboard
action: view_doc
---

# mwt-manager-dashboard-ver-documento

> Skill MCP enfocado: **Manager** · **Dashboard** · permiso **ver-documento** (ver/listar documentos).
