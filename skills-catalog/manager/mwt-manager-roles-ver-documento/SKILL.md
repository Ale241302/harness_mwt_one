---
name: mwt-manager-roles-ver-documento
description: "Rol Manager · módulo Roles y Permisos (roles) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de roles. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/roles.md antes de actuar."
role: manager
module: roles
action: view_doc
---

# mwt-manager-roles-ver-documento

> Skill MCP enfocado: **Manager** · **Roles y Permisos** · permiso **ver-documento** (ver/listar documentos).
