...
description: "Rol Manager · módulo Productos (productos) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de productos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/productos.md antes de actuar."
role: manager
module: productos
action: view_doc
---

# mwt-manager-productos-ver-documento

> Skill MCP enfocado: **Manager** · **Productos** · permiso **ver-documento** (ver/listar documentos).
