---
name: mwt-manager-historial-precios-eliminar
description: "Rol Manager · módulo Historial de precios (historial-precios) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de historial-precios. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/historial-precios.md antes de actuar."
role: manager
module: historial-precios
action: delete
---

# mwt-manager-historial-precios-eliminar

> Skill MCP enfocado: **Manager** · **Historial de precios** · permiso **eliminar** (eliminar/borrar).
