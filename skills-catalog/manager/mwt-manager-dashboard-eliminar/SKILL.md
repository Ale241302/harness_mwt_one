...
description: "Rol Manager · módulo Dashboard (dashboard) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de dashboard. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/dashboard.md antes de actuar."
role: manager
module: dashboard
action: delete
---

# mwt-manager-dashboard-eliminar

> Skill MCP enfocado: **Manager** · **Dashboard** · permiso **eliminar** (eliminar/borrar).
