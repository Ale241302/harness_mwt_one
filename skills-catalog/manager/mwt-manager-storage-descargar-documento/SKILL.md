---
name: mwt-manager-storage-descargar-documento
description: "Rol Manager · módulo Storage (storage) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de storage. Herramientas MCP: artefacto_archivo_descargar. Lee el contrato en _contratos/storage.md antes de actuar."
role: manager
module: storage
action: download_doc
---

# mwt-manager-storage-descargar-documento

> Skill MCP enfocado: **Manager** · **Storage** · permiso **descargar-documento** (descargar un archivo/documento).
