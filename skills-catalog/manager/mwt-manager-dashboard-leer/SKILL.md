---
name: mwt-manager-dashboard-leer
description: Rol Manager · módulo Dashboard (dashboard) · permiso leer (consultar/listar). Herramientas MCP: generar_grafico, render_tabla, generar_reporte, comparar, exportar_xlsx, exportar_csv. Lee el contrato en _contratos/dashboard.md antes de actuar.
role: manager
module: dashboard
action: view
---

# mwt-manager-dashboard-leer

> Skill MCP enfocado: **Manager** · **Dashboard** · permiso **leer** (consultar/listar).
