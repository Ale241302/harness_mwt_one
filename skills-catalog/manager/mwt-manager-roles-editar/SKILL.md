---
name: mwt-manager-roles-editar
description: "Rol Manager · módulo Roles y Permisos (roles) · permiso editar (actualizar/modificar). Úsala cuando el usuario quiera editar, actualizar, corregir o cambiar algo en roles. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/roles.md antes de actuar."
role: manager
module: roles
action: update
---

# mwt-manager-roles-editar

> Skill MCP enfocado: **Manager** · **Roles y Permisos** · permiso **editar** (actualizar/modificar).
