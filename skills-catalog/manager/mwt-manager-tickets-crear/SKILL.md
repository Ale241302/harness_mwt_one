...
description: "Rol Manager · módulo Tickets (tickets) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en tickets. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/tickets.md antes de actuar."
role: manager
module: tickets
action: create
---

# mwt-manager-tickets-crear

> Skill MCP enfocado: **Manager** · **Tickets** · permiso **crear** (crear).
