---
name: mwt-manager-marcas-ver-documento
description: "Rol Manager · módulo Marcas (marcas) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de marcas. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/marcas.md antes de actuar."
role: manager
module: marcas
action: view_doc
---

# mwt-manager-marcas-ver-documento

> Skill MCP enfocado: **Manager** · **Marcas** · permiso **ver-documento** (ver/listar documentos).
