---
name: mwt-manager-productos-descargar-documento
description: "Rol Manager · módulo Productos (productos) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de productos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/productos.md antes de actuar."
role: manager
module: productos
action: download_doc
---

# mwt-manager-productos-descargar-documento

> Skill MCP enfocado: **Manager** · **Productos** · permiso **descargar-documento** (descargar un archivo/documento).
