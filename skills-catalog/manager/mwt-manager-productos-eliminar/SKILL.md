---
name: mwt-manager-productos-eliminar
description: "Rol Manager · módulo Productos (productos) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de productos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/productos.md antes de actuar."
role: manager
module: productos
action: delete
---

# mwt-manager-productos-eliminar

> Skill MCP enfocado: **Manager** · **Productos** · permiso **eliminar** (eliminar/borrar).
