---
name: mwt-manager-portal-descargar-documento
description: "Rol Manager · módulo Portal (portal) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de portal. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/portal.md antes de actuar."
role: manager
module: portal
action: download_doc
---

# mwt-manager-portal-descargar-documento

> Skill MCP enfocado: **Manager** · **Portal** · permiso **descargar-documento** (descargar un archivo/documento).
