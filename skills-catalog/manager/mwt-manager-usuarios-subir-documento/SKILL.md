---
name: mwt-manager-usuarios-subir-documento
description: "Rol Manager · módulo Usuarios (usuarios) · permiso subir-documento (subir un archivo/documento). Úsala cuando el usuario quiera subir o adjuntar un documento a usuarios. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/usuarios.md antes de actuar."
role: manager
module: usuarios
action: upload_doc
---

# mwt-manager-usuarios-subir-documento

> Skill MCP enfocado: **Manager** · **Usuarios** · permiso **subir-documento** (subir un archivo/documento).
