---
name: mwt-manager-notificaciones-eliminar
description: "Rol Manager · módulo Notificaciones (notificaciones) · permiso eliminar (eliminar/borrar). Úsala cuando el usuario quiera eliminar o borrar algo de notificaciones. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/notificaciones.md antes de actuar."
role: manager
module: notificaciones
action: delete
---

# mwt-manager-notificaciones-eliminar

> Skill MCP enfocado: **Manager** · **Notificaciones** · permiso **eliminar** (eliminar/borrar).
