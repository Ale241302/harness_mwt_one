---
name: mwt-manager-historial-precios-ver-documento
description: Rol Manager · módulo Historial de precios (historial-precios) · permiso ver-documento (ver/listar documentos). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/historial-precios.md antes de actuar.
role: manager
module: historial-precios
action: view_doc
---

# mwt-manager-historial-precios-ver-documento

> Skill MCP enfocado: **Manager** · **Historial de precios** · permiso **ver-documento** (ver/listar documentos).
