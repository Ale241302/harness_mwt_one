...
description: "Rol Manager · módulo Motor de Tallas (sizing) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en sizing. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/sizing.md antes de actuar."
role: manager
module: sizing
action: create
---

# mwt-manager-sizing-crear

> Skill MCP enfocado: **Manager** · **Motor de Tallas** · permiso **crear** (crear).
