...
description: Rol Manager · módulo Pagos (pagos) · permiso crear (crear). Herramientas MCP: pago_dry_run, pago_registrar. Lee el contrato en _contratos/pagos.md antes de actuar.
role: manager
module: pagos
action: create
---
