---
name: mwt-manager-sizing-ver-documento
description: "Rol Manager · módulo Motor de Tallas (sizing) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de sizing. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/sizing.md antes de actuar."
role: manager
module: sizing
action: view_doc
---

# mwt-manager-sizing-ver-documento

> Skill MCP enfocado: **Manager** · **Motor de Tallas** · permiso **ver-documento** (ver/listar documentos).
