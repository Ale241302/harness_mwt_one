---
name: mwt-manager-notificaciones-subir-documento
description: "Rol Manager · módulo Notificaciones (notificaciones) · permiso subir-documento (subir un archivo/documento). Úsala cuando el usuario quiera subir o adjuntar un documento a notificaciones. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/notificaciones.md antes de actuar."
role: manager
module: notificaciones
action: upload_doc
---

# mwt-manager-notificaciones-subir-documento

> Skill MCP enfocado: **Manager** · **Notificaciones** · permiso **subir-documento** (subir un archivo/documento).

## Propósito
Operar el módulo **Notificaciones** (`notificaciones`) con la acción **subir-documento** (subir un archivo/documento) usando SOLO
...
- El alcance de este skill es **subir-documento** sobre **Notificaciones**; para otra operación activá el SKILL.md correspondiente.
