---
name: mwt-manager-dashboard-editar
description: "Rol Manager · módulo Dashboard (dashboard) · permiso editar (actualizar/modificar). Úsala cuando el usuario quiera editar, actualizar, corregir o cambiar algo en dashboard. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/dashboard.md antes de actuar."
role: manager
module: dashboard
action: update
---

# mwt-manager-dashboard-editar

> Skill MCP enfocado: **Manager** · **Dashboard** · permiso **editar** (actualizar/modificar).

## Propósito
Operar el módulo **Dashboard** (`dashboard`) con la acción **editar** (actualizar/modificar) usando SOLO
...
- El alcance de este skill es **editar** sobre **Dashboard**; para otra operación activá el SKILL.md correspondiente.
