---
name: mwt-manager-tickets-leer
description: Rol Manager · módulo Tickets (tickets) · permiso leer (consultar/listar). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/tickets.md antes de actuar.
role: manager
module: tickets
action: view
---

# mwt-manager-tickets-leer

> Skill MCP enfocado: **Manager** · **Tickets** · permiso **leer** (consultar/listar).
