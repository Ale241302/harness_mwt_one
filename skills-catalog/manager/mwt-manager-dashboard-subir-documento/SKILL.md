---
name: mwt-manager-dashboard-subir-documento
description: "Rol Manager · módulo Dashboard (dashboard) · permiso subir-documento (subir un archivo/documento). Úsala cuando el usuario quiera subir o adjuntar un documento a dashboard. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/dashboard.md antes de actuar."
role: manager
module: dashboard
action: upload_doc
---

# mwt-manager-dashboard-subir-documento

> Skill MCP enfocado: **Manager** · **Dashboard** · permiso **subir-documento** (subir un archivo/documento).

## Propósito
Operar el módulo **Dashboard** (`dashboard`) con la acción **subir-documento** (subir un archivo/documento) usando SOLO
...
- El alcance de este skill es **subir-documento** sobre **Dashboard**; para otra operación activá el SKILL.md correspondiente.
