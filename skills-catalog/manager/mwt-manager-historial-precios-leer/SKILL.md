---
name: mwt-manager-historial-precios-leer
description: Rol Manager · módulo Historial de precios (historial-precios) · permiso leer (consultar/listar). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/historial-precios.md antes de actuar.
role: manager
module: historial-precios
action: view
---

# mwt-manager-historial-precios-leer

> Skill MCP enfocado: **Manager** · **Historial de precios** · permiso **leer** (consultar/listar).
