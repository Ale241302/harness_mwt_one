...
description: "Rol Manager · módulo Cartera (cartera) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de cartera. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/cartera.md antes de actuar."
role: manager
module: cartera
action: view_doc
---

# mwt-manager-cartera-ver-documento

> Skill MCP enfocado: **Manager** · **Cartera** · permiso **ver-documento** (ver/listar documentos).
