---
name: mwt-manager-productos-leer
description: Rol Manager · módulo Productos (productos) · permiso leer (consultar/listar). Herramientas MCP: producto_listar, producto_obtener, producto_buscar, producto_precio_cliente, producto_ficha_tecnica, ncm_listar. Lee el contrato en _contratos/productos.md antes de actuar.
role: manager
module: productos
action: view
---

# mwt-manager-productos-leer

> Skill MCP enfocado: **Manager** · **Productos** · permiso **leer** (consultar/listar).
