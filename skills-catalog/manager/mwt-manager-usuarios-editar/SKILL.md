...
description: Rol Manager · módulo Usuarios (usuarios) · permiso editar (actualizar/modificar). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/usuarios.md antes de actuar.
role: manager
module: usuarios
action: update
---
