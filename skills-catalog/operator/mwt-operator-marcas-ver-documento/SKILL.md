---
name: mwt-operator-marcas-ver-documento
description: "Rol Operador · módulo Marcas (marcas) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de marcas. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/marcas.md antes de actuar."
role: operator
module: marcas
action: view_doc
---

# mwt-operator-marcas-ver-documento

> Skill MCP enfocado: **Operador** · **Marcas** · permiso **ver-documento** (ver/listar documentos).
