---
name: mwt-operator-transferencias-ver-documento
description: "Rol Operador · módulo Transferencias (transferencias) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de transferencias. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/transferencias.md antes de actuar."
role: operator
module: transferencias
action: view_doc
---

# mwt-operator-transferencias-ver-documento

> Skill MCP enfocado: **Operador** · **Transferencias** · permiso **ver-documento** (ver/listar documentos).

## Propósito
Operar el módulo **Transferencias** (`transferencias`) con la acción **ver-documento** (ver/listar documentos) usando SOLO
...
- El alcance de este skill es **ver-documento** sobre **Transferencias**; para otra operación activá el SKILL.md correspondiente.
