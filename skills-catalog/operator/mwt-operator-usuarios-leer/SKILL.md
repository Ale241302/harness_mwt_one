...
description: "Rol Operador · módulo Usuarios (usuarios) · permiso leer (consultar/listar). Úsala cuando el usuario quiera consultar, listar, ver, buscar o revisar usuarios (por ejemplo 'muéstrame usuarios' o 'busca en usuarios'). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/usuarios.md antes de actuar."
role: operator
module: usuarios
action: view
---

# mwt-operator-usuarios-leer

> Skill MCP enfocado: **Operador** · **Usuarios** · permiso **leer** (consultar/listar).
