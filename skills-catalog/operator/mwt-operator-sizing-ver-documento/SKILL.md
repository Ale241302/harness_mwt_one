---
name: mwt-operator-sizing-ver-documento
description: "Rol Operador · módulo Motor de Tallas (sizing) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de sizing. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/sizing.md antes de actuar."
role: operator
module: sizing
action: view_doc
---

# mwt-operator-sizing-ver-documento

> Skill MCP enfocado: **Operador** · **Motor de Tallas** · permiso **ver-documento** (ver/listar documentos).
