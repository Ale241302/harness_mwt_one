...
description: "Rol Operador · módulo Expedientes (expedientes) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de expedientes. Herramientas MCP: documento_listar. Lee el contrato en _contratos/expedientes.md antes de actuar."
role: operator
module: expedientes
action: view_doc
---

# mwt-operator-expedientes-ver-documento

> Skill MCP enfocado: **Operador** · **Expedientes** · permiso **ver-documento** (ver/listar documentos).
