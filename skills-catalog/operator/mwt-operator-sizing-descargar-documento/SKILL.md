---
name: mwt-operator-sizing-descargar-documento
description: "Rol Operador · módulo Motor de Tallas (sizing) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de sizing. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/sizing.md antes de actuar."
role: operator
module: sizing
action: download_doc
---

# mwt-operator-sizing-descargar-documento

> Skill MCP enfocado: **Operador** · **Motor de Tallas** · permiso **descargar-documento** (descargar un archivo/documento).
