---
name: mwt-operator-tickets-descargar-documento
description: "Rol Operador · módulo Tickets (tickets) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de tickets. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/tickets.md antes de actuar."
role: operator
module: tickets
action: download_doc
---

# mwt-operator-tickets-descargar-documento

> Skill MCP enfocado: **Operador** · **Tickets** · permiso **descargar-documento** (descargar un archivo/documento).
