...
description: "Rol Operador · módulo Inventario (inventario) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en inventario. Herramientas MCP: recepcion_crear. Lee el contrato en _contratos/inventario.md antes de actuar."
role: operator
module: inventario
action: create
---
