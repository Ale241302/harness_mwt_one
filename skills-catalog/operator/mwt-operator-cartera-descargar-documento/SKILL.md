---
name: mwt-operator-cartera-descargar-documento
description: "Rol Operador · módulo Cartera (cartera) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de cartera. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/cartera.md antes de actuar."
role: operator
module: cartera
action: download_doc
---

# mwt-operator-cartera-descargar-documento

> Skill MCP enfocado: **Operador** · **Cartera** · permiso **descargar-documento** (descargar un archivo/documento).
