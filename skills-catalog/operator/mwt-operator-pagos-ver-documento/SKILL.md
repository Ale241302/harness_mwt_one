---
name: mwt-operator-pagos-ver-documento
description: "Rol Operador · módulo Pagos (pagos) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de pagos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/pagos.md antes de actuar."
role: operator
module: pagos
action: view_doc
---

# mwt-operator-pagos-ver-documento

> Skill MCP enfocado: **Operador** · **Pagos** · permiso **ver-documento** (ver/listar documentos).
