---
name: mwt-operator-sizing-leer
description: "Rol Operador · módulo Motor de Tallas (sizing) · permiso leer (consultar/listar). Úsala cuando el usuario quiera consultar, listar, ver, buscar o revisar sizing (por ejemplo 'muéstrame sizing' o 'busca en sizing'). Herramientas MCP: tallas_listar. Lee el contrato en _contratos/sizing.md antes de actuar."
role: operator
module: sizing
action: view
---

# mwt-operator-sizing-leer

> Skill MCP enfocado: **Operador** · **Motor de Tallas** · permiso **leer** (consultar/listar).
