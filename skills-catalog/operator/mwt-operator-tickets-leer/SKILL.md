---
name: mwt-operator-tickets-leer
description: Rol Operador · módulo Tickets (tickets) · permiso leer (consultar/listar). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/tickets.md antes de actuar.
role: operator
module: tickets
action: view
---

# mwt-operator-tickets-leer

> Skill MCP enfocado: **Operador** · **Tickets** · permiso **leer** (consultar/listar).
