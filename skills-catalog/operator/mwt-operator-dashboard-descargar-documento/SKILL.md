---
name: mwt-operator-dashboard-descargar-documento
description: "Rol Operador · módulo Dashboard (dashboard) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de dashboard. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/dashboard.md antes de actuar."
role: operator
module: dashboard
action: download_doc
---

# mwt-operator-dashboard-descargar-documento

> Skill MCP enfocado: **Operador** · **Dashboard** · permiso **descargar-documento** (descargar un archivo/documento).
