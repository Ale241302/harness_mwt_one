...
description: "Rol Operador · módulo Productos (productos) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de productos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/productos.md antes de actuar."
role: operator
module: productos
action: view_doc
---

# mwt-operator-productos-ver-documento

> Skill MCP enfocado: **Operador** · **Productos** · permiso **ver-documento** (ver/listar documentos).
