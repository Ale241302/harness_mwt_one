...
description: "Rol Operador · módulo Nodos (nodos) · permiso crear (crear). Úsala cuando el usuario quiera crear, registrar o dar de alta algo en nodos. Herramientas MCP: nodo_crear, nodo_artefacto_crear. Lee el contrato en _contratos/nodos.md antes de actuar."
role: operator
module: nodos
action: create
---

# mwt-operator-nodos-crear

> Skill MCP enfocado: **Operador** · **Nodos** · permiso **crear** (crear).
