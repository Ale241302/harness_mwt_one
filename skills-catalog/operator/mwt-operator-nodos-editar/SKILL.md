---
name: mwt-operator-nodos-editar
description: "Rol Operador · módulo Nodos (nodos) · permiso editar (actualizar/modificar). Úsala cuando el usuario quiera editar, actualizar, corregir o cambiar algo en nodos. Herramientas MCP: nodo_editar, artefacto_editar, artefacto_publicar. Lee el contrato en _contratos/nodos.md antes de actuar."
role: operator
module: nodos
action: update
---

# mwt-operator-nodos-editar

> Skill MCP enfocado: **Operador** · **Nodos** · permiso **editar** (actualizar/modificar).
