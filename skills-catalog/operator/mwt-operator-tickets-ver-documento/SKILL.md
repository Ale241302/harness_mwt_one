...
description: "Rol Operador · módulo Tickets (tickets) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de tickets. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/tickets.md antes de actuar."
role: operator
module: tickets
action: view_doc
---

# mwt-operator-tickets-ver-documento

> Skill MCP enfocado: **Operador** · **Tickets** · permiso **ver-documento** (ver/listar documentos).
