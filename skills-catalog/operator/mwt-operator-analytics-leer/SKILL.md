---
name: mwt-operator-analytics-leer
description: Rol Operador · módulo Analytics (analytics) · permiso leer (consultar/listar). Herramientas MCP: cashflow_chart, margen_marcas_chart, aging_chart, exposicion_chart, reporte_cobranza, reporte_expedientes, dashboard_resumen. Lee el contrato en _contratos/analytics.md antes de actuar.
role: operator
module: analytics
action: view
---

# mwt-operator-analytics-leer

> Skill MCP enfocado: **Operador** · **Analytics** · permiso **leer** (consultar/listar).
