---
name: mwt-operator-nodos-ver-documento
description: "Rol Operador · módulo Nodos (nodos) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de nodos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/nodos.md antes de actuar."
role: operator
module: nodos
action: view_doc
---

# mwt-operator-nodos-ver-documento

> Skill MCP enfocado: **Operador** · **Nodos** · permiso **ver-documento** (ver/listar documentos).
