---
name: mwt-operator-productos-descargar-documento
description: "Rol Operador · módulo Productos (productos) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de productos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/productos.md antes de actuar."
role: operator
module: productos
action: download_doc
---

# mwt-operator-productos-descargar-documento

> Skill MCP enfocado: **Operador** · **Productos** · permiso **descargar-documento** (descargar un archivo/documento).
