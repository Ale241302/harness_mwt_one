...
description: "Rol Operador · módulo Dashboard (dashboard) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de dashboard. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/dashboard.md antes de actuar."
role: operator
module: dashboard
action: view_doc
---

# mwt-operator-dashboard-ver-documento

> Skill MCP enfocado: **Operador** · **Dashboard** · permiso **ver-documento** (ver/listar documentos).
