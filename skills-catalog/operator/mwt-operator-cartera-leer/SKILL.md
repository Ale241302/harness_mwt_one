...
description: "Rol Operador · módulo Cartera (cartera) · permiso leer (consultar/listar). Úsala cuando el usuario quiera consultar, listar, ver, buscar o revisar cartera (por ejemplo 'muéstrame cartera' o 'busca en cartera'). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/cartera.md antes de actuar."
role: operator
module: cartera
action: view
---

# mwt-operator-cartera-leer

> Skill MCP enfocado: **Operador** · **Cartera** · permiso **leer** (consultar/listar).
