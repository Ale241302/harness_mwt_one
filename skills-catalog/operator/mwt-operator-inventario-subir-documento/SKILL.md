---
name: mwt-operator-inventario-subir-documento
description: "Rol Operador · módulo Inventario (inventario) · permiso subir-documento (subir un archivo/documento). Úsala cuando el usuario quiera subir o adjuntar un documento a inventario. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/inventario.md antes de actuar."
role: operator
module: inventario
action: upload_doc
---

# mwt-operator-inventario-subir-documento

> Skill MCP enfocado: **Operador** · **Inventario** · permiso **subir-documento** (subir un archivo/documento).
