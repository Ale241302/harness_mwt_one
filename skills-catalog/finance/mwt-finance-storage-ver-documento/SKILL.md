---
name: mwt-finance-storage-ver-documento
description: "Rol Finance · módulo Storage (storage) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de storage. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/storage.md antes de actuar."
role: finance
module: storage
action: view_doc
---

# mwt-finance-storage-ver-documento

> Skill MCP enfocado: **Finance** · **Storage** · permiso **ver-documento** (ver/listar documentos).
