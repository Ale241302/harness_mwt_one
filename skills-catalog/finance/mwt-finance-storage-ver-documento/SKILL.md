...
description: Rol Finance · módulo Storage (storage) · permiso ver-documento (ver/listar documentos). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/storage.md antes de actuar.
role: finance
module: storage
action: view_doc
---
