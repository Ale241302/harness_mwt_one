---
name: mwt-finance-roles-ver-documento
description: "Rol Finance · módulo Roles y Permisos (roles) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de roles. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/roles.md antes de actuar."
role: finance
module: roles
action: view_doc
---

# mwt-finance-roles-ver-documento

> Skill MCP enfocado: **Finance** · **Roles y Permisos** · permiso **ver-documento** (ver/listar documentos).
