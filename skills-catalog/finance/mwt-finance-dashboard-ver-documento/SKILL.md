...
description: "Rol Finance · módulo Dashboard (dashboard) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de dashboard. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/dashboard.md antes de actuar."
role: finance
module: dashboard
action: view_doc
---

# mwt-finance-dashboard-ver-documento

> Skill MCP enfocado: **Finance** · **Dashboard** · permiso **ver-documento** (ver/listar documentos).
