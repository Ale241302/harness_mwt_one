---
name: mwt-finance-sizing-ver-documento
description: "Rol Finance · módulo Motor de Tallas (sizing) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de sizing. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/sizing.md antes de actuar."
role: finance
module: sizing
action: view_doc
---

# mwt-finance-sizing-ver-documento

> Skill MCP enfocado: **Finance** · **Motor de Tallas** · permiso **ver-documento** (ver/listar documentos).
