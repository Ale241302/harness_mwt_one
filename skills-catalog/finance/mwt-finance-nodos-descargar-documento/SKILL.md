...
description: "Rol Finance · módulo Nodos (nodos) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de nodos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/nodos.md antes de actuar."
role: finance
module: nodos
action: download_doc
---

# mwt-finance-nodos-descargar-documento

> Skill MCP enfocado: **Finance** · **Nodos** · permiso **descargar-documento** (descargar un archivo/documento).
