...
description: "Rol Finance · módulo Pagos (pagos) · permiso ver-documento (ver/listar documentos). Úsala cuando el usuario quiera ver o listar los documentos de pagos. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/pagos.md antes de actuar."
role: finance
module: pagos
action: view_doc
---

# mwt-finance-pagos-ver-documento

> Skill MCP enfocado: **Finance** · **Pagos** · permiso **ver-documento** (ver/listar documentos).
