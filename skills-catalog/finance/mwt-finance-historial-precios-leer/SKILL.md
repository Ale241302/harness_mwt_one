---
name: mwt-finance-historial-precios-leer
description: Rol Finance · módulo Historial de precios (historial-precios) · permiso leer (consultar/listar). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/historial-precios.md antes de actuar.
role: finance
module: historial-precios
action: view
---

# mwt-finance-historial-precios-leer

> Skill MCP enfocado: **Finance** · **Historial de precios** · permiso **leer** (consultar/listar).
