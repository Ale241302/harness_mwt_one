...
description: "Rol Finance · módulo Motor de Tallas (sizing) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de sizing. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/sizing.md antes de actuar."
role: finance
module: sizing
action: download_doc
---

# mwt-finance-sizing-descargar-documento

> Skill MCP enfocado: **Finance** · **Motor de Tallas** · permiso **descargar-documento** (descargar un archivo/documento).
