...
description: Rol Finance · módulo Usuarios (usuarios) · permiso descargar-documento (descargar un archivo/documento). Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/usuarios.md antes de actuar.
role: finance
module: usuarios
action: download_doc
---
