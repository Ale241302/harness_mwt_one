---
name: mwt-finance-usuarios-descargar-documento
description: "Rol Finance · módulo Usuarios (usuarios) · permiso descargar-documento (descargar un archivo/documento). Úsala cuando el usuario quiera descargar un documento o archivo de usuarios. Herramientas MCP: ninguna tool directa en esta acción. Lee el contrato en _contratos/usuarios.md antes de actuar."
role: finance
module: usuarios
action: download_doc
---

# mwt-finance-usuarios-descargar-documento

> Skill MCP enfocado: **Finance** · **Usuarios** · permiso **descargar-documento** (descargar un archivo/documento).
