---
name: mwt-finance-nodos-leer
description: Rol Finance · módulo Nodos (nodos) · permiso leer (consultar/listar). Herramientas MCP: nodo_listar, nodo_obtener, nodo_artefactos_listar, builder_templates_listar, builder_template_obtener. Lee el contrato en _contratos/nodos.md antes de actuar.
role: finance
module: nodos
action: view
---

# mwt-finance-nodos-leer

> Skill MCP enfocado: **Finance** · **Nodos** · permiso **leer** (consultar/listar).
